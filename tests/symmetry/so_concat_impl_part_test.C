...
void so_concat_impl_part_test::test_1() throw(libtest::test_exception) {
	...
	symmetry_operation_params<so_concat_t> params(
		set1, set2, permutation<5>(), false, bis5, set3);
...
void so_concat_impl_part_test::test_2(bool sign)
	...
	symmetry_operation_params<so_concat_t> params(
		set1, set2, permutation<4>(), false, bis4, set3);
...
void so_concat_impl_part_test::test_3(bool sign)
	...
	symmetry_operation_params<so_concat_t> params(set1, set2,
			permutation<4>().permute(0, 1).permute(1, 2), false, bis4, set3);
...
void so_concat_impl_part_test::test_4(bool sign) throw(libtest::test_exception) {
	...
	symmetry_operation_params< so_concat<2, 2, double> > params(set1, set2,
			permutation<4>().permute(1, 3).permute(1, 2), false, bis4, set3);
...
void so_concat_impl_part_test::test_5(bool sign) throw(libtest::test_exception) {
	...
	symmetry_operation_params<so_concat_t> params(
		set1, set2, perm, false, bisb, set3);
...
void so_concat_impl_part_test::test_6() throw(libtest::test_exception) {
	...
	symmetry_operation_params<so_concat_t> params(
		set1, set2, perm, false, bisc, set3);
...
void so_concat_impl_part_test::test_7() throw(libtest::test_exception) {
	...
	permutation<4> perm; perm.permute(2, 3).permute(0, 2);
	symmetry_operation_params<so_concat_t> params(
		set2, set1, perm, false, bisc, set3);
...
/** \test Concatenates two partition sets (2-space) as direct sum
 **/
void so_concat_impl_part_test::test_8(
        bool sign) throw(libtest::test_exception) {

    static const char *testname = "so_concat_impl_part_test::test_8()";
    ...
    elem2.mark_forbidden(i00);
    elem2.mark_forbidden(i11);
    ...
    elem3.add_map(i0000, i1100, true);
    elem3.add_map(i0001, i0010, sign);
    elem3.add_map(i0010, i1101, sign);
    elem3.add_map(i1101, i1110, sign);
    elem3.add_map(i0011, i1111, true);
    elem3.add_map(i0101, i0110, sign);
    elem3.add_map(i1001, i0110, sign);
    elem3.mark_forbidden(i0100);
    elem3.mark_forbidden(i0111);
    elem3.mark_forbidden(i1000);
    elem3.mark_forbidden(i1011);
