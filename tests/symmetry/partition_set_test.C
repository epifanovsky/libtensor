...
void partition_set_test::test_add_2(bool sign) throw(libtest::test_exception) {
    ...
    try {
        ...
        index<4> i0000, i0101, i1010, i0110, i1001, i0011, i1100, i1111;
        ...
        sp1.mark_forbidden(i0110);
        sp1.mark_forbidden(i1001);

        sp2.add_map(i0000, i1111, sign);
        sp2.add_map(i0110, i1001, sign);
        sp2.mark_forbidden(i1100);
        sp2.mark_forbidden(i0011);
 ...
 **/
void partition_set_test::test_add_3a(
    ...
    try {
        ...
        sp1.add_map(i0000, i1111, sign);
        sp1.add_map(i0101, i1010, sign);
        sp1.mark_forbidden(i0001);
        sp1.mark_forbidden(i1110);
        sp2.add_map(i0011, i1100, sign);
        sp2.add_map(i0110, i1001, sign);
        sp2.mark_forbidden(i0100);
        sp2.mark_forbidden(i1011);
        ...
        sp_ref.mark_forbidden(i0001); sp_ref.mark_forbidden(i1110);
        sp_ref.mark_forbidden(i1000); sp_ref.mark_forbidden(i0111);
...
void partition_set_test::test_add_4(bool sign) throw(libtest::test_exception) {
    ...
    try {
        ...
        sp1.mark_forbidden(i0100); sp1.mark_forbidden(i1000);
        sp2.add_map(i0000, i1010, sign);
        sp2.mark_forbidden(i0010);
        sp2.mark_forbidden(i1000);
        ...
        sp_ref.mark_forbidden(i0001);
        sp_ref.mark_forbidden(i0010);
        sp_ref.mark_forbidden(i0100);
        sp_ref.mark_forbidden(i1000);
        sp_ref.mark_forbidden(i1110);
        sp_ref.mark_forbidden(i1101);
        sp_ref.mark_forbidden(i1011);
        sp_ref.mark_forbidden(i0111);
        sp_ref.mark_forbidden(i0101);
        sp_ref.mark_forbidden(i1010);
        sp_ref.mark_forbidden(i0110);
        sp_ref.mark_forbidden(i1001);
...
void partition_set_test::test_add_5() throw(libtest::test_exception) {
    ...
    try {
        ...
        sp1.mark_forbidden(i0100);
        sp2.add_map(i0000, i1000, true);

        se_part<4, double> sp_ref(bisb, m1111, 2);
        sp_ref.add_map(i0000, i0010, true);
        sp_ref.add_map(i0010, i1100, true);
        sp_ref.add_map(i1100, i1110, true);
        sp_ref.add_map(i0001, i0011, true);
        sp_ref.add_map(i0011, i1101, true);
        sp_ref.add_map(i1101, i1111, true);
        sp_ref.add_map(i1000, i1010, true);
        sp_ref.add_map(i1001, i1011, true);
        sp_ref.mark_forbidden(i0100);
        sp_ref.mark_forbidden(i0101);
        sp_ref.mark_forbidden(i0110);
        sp_ref.mark_forbidden(i0111);
...
void partition_set_test::test_add_8(bool sign) throw(libtest::test_exception) {
    ...
    try {
        ...
        sp_ref.add_map(i010, i101, sign);
        sp_ref.add_map(i101, i111, sign);

        sp_ref.mark_forbidden(i001);
        sp_ref.mark_forbidden(i011);
        sp_ref.mark_forbidden(i100);
        sp_ref.mark_forbidden(i110);
...
throw(libtest::test_exception) {
    ...
    try {
        ...
        index<4> i0000, i1111, i0011, i1100, i0101, i1010, i0100, i1000;
        i1100[0] = 1; i1100[1] = 1; i0011[2] = 1; i0011[3] = 1;
        i1010[0] = 1; i0101[1] = 1; i1010[2] = 1; i0101[3] = 1;
        i1111[0] = 1; i1111[1] = 1; i1111[2] = 1; i1111[3] = 1;
        i1000[0] = 1; i0100[1] = 1;
        index<4> i0022, i0202, i0033, i0303, i0021, i0201;
        i0022[2] = 2; i0022[3] = 2; i0202[1] = 2; i0202[3] = 2;
        i0033[2] = 3; i0033[3] = 3; i0303[1] = 3; i0303[3] = 3;
        i0201[1] = 2; i0201[3] = 1; i0021[2] = 2; i0021[3] = 1;
...
throw(libtest::test_exception) {
    ...
    static const char *testname =
            "partition_set_test::test_intersect_5a(bool)";
    ...
    try {
        ...
        sp1.mark_forbidden(i101);
        sp2.add_map(i000, i111, sign);
        sp2.add_map(i001, i101, sign);
        sp2.mark_forbidden(i010);
        sp_ref.add_map(i000, i111, sign);
        sp_ref.mark_forbidden(i010);
...
throw(libtest::test_exception) {
    ...
    try {
        ...
        sp1.mark_forbidden(i000);
        sp1.mark_forbidden(i111);
        sp2.add_map(i001, i110, sign);
        sp2.mark_forbidden(i000);
        sp_ref.add_map(i001, i110, sign);
        sp_ref.mark_forbidden(i000);
...
/**	\test Stabilize a partition set with a single partition,
        one stabilizing step
 **/
void partition_set_test::test_stabilize_2(bool sign)
throw(libtest::test_exception) {

    static const char *testname =
            "partition_set_test::test_stabilize_2(bool)";
    ...
    try {
        ...
        sp1.add_map(i1010, i1111, sign);
        sp1.mark_forbidden(i0001);
        sp1.mark_forbidden(i0010);
        sp1.mark_forbidden(i0011);
        sp1.mark_forbidden(i0100);
        sp1.mark_forbidden(i0110);
        sp1.mark_forbidden(i0111);
        sp1.mark_forbidden(i1000);
        sp1.mark_forbidden(i1001);
        sp1.mark_forbidden(i1011);
        sp1.mark_forbidden(i1100);
        sp1.mark_forbidden(i1101);
        sp1.mark_forbidden(i1110);
...
throw(libtest::test_exception) {
    ...
    try {
        ...
        se_part<2, double> sp1a(bisa, m11, 2),
                sp1b(bisb, m11, 2), sp_ref(bisa, m11, 2);
        se_part<4, double> sp2(bisc, m1111, 2);
        sp1a.add_map(i00, i11, sign);
        sp1a.mark_forbidden(i01);
        sp1a.mark_forbidden(i10);
        sp1b.add_map(i01, i10, true);
        sp1b.mark_forbidden(i00);
        sp1b.mark_forbidden(i11);
        sp_ref.add_map(i01, i10, sign);
        sp_ref.mark_forbidden(i00);
        sp_ref.mark_forbidden(i11);
        sp2.add_map(i0001, i0100, true);
        sp2.add_map(i0100, i1011, sign);
        sp2.add_map(i1011, i1110, true);
        sp2.mark_forbidden(i0000);
        sp2.mark_forbidden(i0010);
        sp2.mark_forbidden(i0011);
        sp2.mark_forbidden(i0101);
        sp2.mark_forbidden(i0110);
        sp2.mark_forbidden(i0111);
        sp2.mark_forbidden(i1000);
        sp2.mark_forbidden(i1001);
        sp2.mark_forbidden(i1010);
        sp2.mark_forbidden(i1100);
        sp2.mark_forbidden(i1101);
        sp2.mark_forbidden(i1111);
...
throw(libtest::test_exception) {
    ...
    try {
        ...
        sp1.add_map(i0, i1, sign);
        sp2.add_map(i000, i111, sign);
        sp2.mark_forbidden(i001);
        sp2.mark_forbidden(i011);
        sp2.mark_forbidden(i100);
