#ifndef LIBTENSOR_SO_REDUCE_IMPL_PERM_TEST_H
#define LIBTENSOR_SO_REDUCE_IMPL_PERM_TEST_H
 ...
 **/
class so_reduce_impl_perm_test : public libtest::unit_test {
public:
...
#endif // LIBTENSOR_SO_REDUCE_IMPL_PERM_TEST_H
