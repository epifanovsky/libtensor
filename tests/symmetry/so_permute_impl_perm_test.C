#include <libtensor/symmetry/perm/so_permute_impl_perm.h>
...
void so_permute_impl_perm_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_permute_impl_perm_test::test_1() throw(libtest::test_exception) {

	static const char *testname = "so_permute_impl_perm_test::test_1()";
