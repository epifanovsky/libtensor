#include <libtensor/symmetry/so_mult_impl_perm.h>
...
void so_mult_impl_perm_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_mult_impl_perm_test::test_1() throw(libtest::test_exception) {

	static const char *testname = "so_mult_impl_perm_test::test_1()";
...
/**	\test Tests that the intersection of an empty set and a non-empty set
		yields an empty set
 **/
void so_mult_impl_perm_test::test_2() throw(libtest::test_exception) {

	static const char *testname = "so_mult_impl_perm_test::test_2()";
...
/**	\test Tests that the intersection of two non-overlapping non-empty sets
		yields an empty set
 **/
void so_mult_impl_perm_test::test_3() throw(libtest::test_exception) {

	static const char *testname = "so_mult_impl_perm_test::test_3()";
 ...
 **/
void so_mult_impl_perm_test::test_4() throw(libtest::test_exception) {

	static const char *testname = "so_mult_impl_perm_test::test_4()";
...
/**	\test Tests the intersection of two non-empty sets
 **/
void so_mult_impl_perm_test::test_5() throw(libtest::test_exception) {

	static const char *testname = "so_mult_impl_perm_test::test_5()";
	...
	permutation<2> p; p.permute(0, 1);
	se_t elem1(p, true), elem2(p, false);
	...
	symmetry_element_set_adapter<2, double, se_t>::iterator i =
		adapter.begin();
	const se_t &elem3 = adapter.get_elem(i);
	i++;
	if(i != adapter.end()) {
		fail_test(testname, __FILE__, __LINE__,
			"Expected only one element.");
	...
	if(!elem1.get_perm().equals(elem3.get_perm())) {
		fail_test(testname, __FILE__, __LINE__, "elem1 != elem2");
	}
