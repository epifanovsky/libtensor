...
void so_dirprod_impl_perm_test::test_empty_3(
    ...
    se3_t elemb(p1, false);
    se5_t elemc(p2, false);
...
void so_dirprod_impl_perm_test::test_nn_1(
    ...
    se3_t elemb1(permutation<3>().permute(0, 1).permute(1, 2), symm2);
    se3_t elemb2(permutation<3>().permute(0, 1), true);
    se5_t elemc1(permutation<5>().permute(0, 1), symm1);
    se5_t elemc2(permutation<5>().permute(2, 3).permute(3, 4), symm2);
    se5_t elemc3(permutation<5>().permute(2, 3), true);
...
void so_dirprod_impl_perm_test::test_nn_2(
    ...
    se3_t elema1(permutation<3>().permute(0, 1).permute(1, 2), symm1);
    se3_t elema2(permutation<3>().permute(0, 1), true);
    se2_t elemb(permutation<2>().permute(0, 1), symm2);
    se5_t elemc1(permutation<5>().permute(0, 2).permute(2, 3), symm1);
    se5_t elemc2(permutation<5>().permute(0, 3), true);
