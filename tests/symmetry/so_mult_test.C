...
#include <libtensor/symmetry/so_mult.h>
...
void so_mult_test::perform() throw(libtest::test_exception) {

	test_1();
	test_2();
	test_3();
	test_4();
	test_5(true); test_5(false);
}


/**	\test Empty + empty %symmetries in 4-space.
 **/
void so_mult_test::test_1() throw(libtest::test_exception) {

	static const char *testname = "so_mult_test::test_1()";
	...
	so_mult<4, double>(sym1, perm1, sym2, perm2).perform(sym3);
 ...
 **/
void so_mult_test::test_2() throw(libtest::test_exception) {

	static const char *testname = "so_mult_test::test_2()";
	...
	so_mult<4, double>(sym1, perm0, sym2, perm0).perform(sym3);
 ...
 **/
void so_mult_test::test_3() throw(libtest::test_exception) {

	static const char *testname = "so_mult_test::test_3()";
 ...
 **/
void so_mult_test::test_4() throw(libtest::test_exception) {

	static const char *testname = "so_mult_test::test_4()";
 ...
 **/
void so_mult_test::test_5(bool symm) throw(libtest::test_exception) {

	static const char *testname = "so_mult_test::test_5()";
	...
	p2.permute(2, 3);
	p3.permute(1, 2);
	se_perm<4, double> e1(p1, true), e2(p2, true), e3(p3, symm);
	sym1.insert(e1);
	sym1.insert(e2);
	sym2.insert(e3);
	...
	try {
		...
		if (symm != elem1i.is_symm()) {
			fail_test(testname, __FILE__, __LINE__,
				"Bad symm flag in elem1i");
		}
