...
private:
    ...
    unit_test_factory<er_merge_test> m_utf_er_merge;
    unit_test_factory<er_optimize_test> m_utf_er_optimize;
    unit_test_factory<er_reduce_test> m_utf_er_reduce;
