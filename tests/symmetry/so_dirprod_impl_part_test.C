#include <libtensor/symmetry/so_dirprod_impl_part.h>
...
void so_dirprod_impl_part_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_dirprod_impl_part_test::test_empty_1() throw(libtest::test_exception) {

	static const char *testname =
	        "so_dirprod_impl_part_test::test_empty_1()";
 ...
 **/
void so_dirprod_impl_part_test::test_empty_2(
        bool perm) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_part_test::test_empty_2(" << perm << ")";
 ...
 **/
void so_dirprod_impl_part_test::test_empty_3(
        bool perm) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_part_test::test_empty_3(" << perm << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirprod_impl_part_test::test_nn_1(
        bool symm1, bool symm2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_part_test::test_nn_1(" << symm1 << ", "
            << symm2 << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirprod_impl_part_test::test_nn_2(
        bool symm1, bool symm2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_part_test::test_nn_2(" << symm1 << ", "
            << symm2 << ")";
    std::string tns = tnss.str();
