#ifndef LIBTENSOR_SO_REDUCE_IMPL_LABEL_TEST_H
#define LIBTENSOR_SO_REDUCE_IMPL_LABEL_TEST_H

#include "se_label_test_base.h"

namespace libtensor {

/**	\brief Tests the libtensor::so_reduce_impl_label class

	\ingroup libtensor_tests_sym
 **/
class so_reduce_impl_label_test : public se_label_test_base {
public:
...
#endif // LIBTENSOR_SO_REDUCE_IMPL_LABEL_TEST_H
