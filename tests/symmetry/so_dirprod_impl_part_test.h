#ifndef LIBTENSOR_SO_DIRPROD_IMPL_PART_TEST_H
#define LIBTENSOR_SO_DIRPROD_IMPL_PART_TEST_H
...
/**	\brief Tests the libtensor::so_dirprod_impl_part class

	\ingroup libtensor_tests_sym
 **/
class so_dirprod_impl_part_test : public libtest::unit_test {
public:
