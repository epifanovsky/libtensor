#ifndef LIBTENSOR_SO_DIRSUM_IMPL_PERM_TEST_H
#define LIBTENSOR_SO_DIRSUM_IMPL_PERM_TEST_H
...
/**	\brief Tests the libtensor::so_dirsum_impl_perm class
...
#endif // LIBTENSOR_SO_DIRSUM_IMPL_PERM_TEST_H
