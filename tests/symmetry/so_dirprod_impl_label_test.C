 ...
 **/
void so_dirprod_impl_label_test::test_empty_1(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_label_test::test_empty_1(" << table_id << ")";
...
void so_dirprod_impl_label_test::test_empty_2(
    ...
    std::ostringstream tnss;
    tnss << "so_dirprod_impl_label_test::test_empty_2("
            << table_id << ", " << perm << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirprod_impl_label_test::test_nn_1(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_label_test::test_nn_1(" << table_id << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirprod_impl_label_test::test_nn_2(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_label_test::test_nn_2(" << table_id << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirprod_impl_label_test::test_nn_3(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirprod_impl_label_test::test_nn_3(" << table_id << ")";
    std::string tns = tnss.str();
