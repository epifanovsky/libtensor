#ifndef LIBTENSOR_SO_DIRPROD_IMPL_LABEL_TEST_H
#define LIBTENSOR_SO_DIRPROD_IMPL_LABEL_TEST_H
 ...
 **/
class so_dirprod_impl_label_test : public se_label_test_base {
public:
...
#endif // LIBTENSOR_SO_DIRPROD_IMPL_LABEL_TEST_H
