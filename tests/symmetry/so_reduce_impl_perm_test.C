...
void so_reduce_impl_perm_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_reduce_impl_perm_test::test_empty_1() throw(libtest::test_exception) {

	static const char *testname = "so_reduce_impl_perm_test::test_empty_1()";
...
/**	\test Tests that two reduction steps on an empty group yield an empty
		group of lower order
 **/
void so_reduce_impl_perm_test::test_empty_2() throw(libtest::test_exception) {

	static const char *testname = "so_reduce_impl_perm_test::test_empty_2()";
 ...
 **/
void so_reduce_impl_perm_test::test_nm1_1(
        bool symm) throw(libtest::test_exception) {

    std::ostringstream tnss;
	tnss << "so_reduce_impl_perm_test::test_nm1_1(" << symm << ")";
 ...
 **/
void so_reduce_impl_perm_test::test_nm1_2(
        bool symm) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_perm_test::test_nm1_2(" << symm << ")";
 ...
 **/
void so_reduce_impl_perm_test::test_nmk_1(
        bool symm) throw(libtest::test_exception) {

    std::ostringstream tnss;
	tnss << "so_reduce_impl_perm_test::test_nmk_1(" << symm << ")";
 ...
 **/
void so_reduce_impl_perm_test::test_nmk_2(
        bool symm) throw(libtest::test_exception) {

    std::ostringstream tnss;
	tnss << "so_reduce_impl_perm_test::test_nmk_2(" << symm << ")";
 ...
 **/
void so_reduce_impl_perm_test::test_nmk_3(
        bool symm1, bool symm2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_perm_test::test_nmk_3(" <<
            symm1 << ", " << symm2 << ")";
