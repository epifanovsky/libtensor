#ifndef LIBTENSOR_SO_APPLY_SE_PERM_TEST_H
#define LIBTENSOR_SO_APPLY_SE_PERM_TEST_H
...
/** \brief Tests the libtensor::so_apply_se_perm class
...
#endif // LIBTENSOR_SO_APPLY_SE_PERM_TEST_H
