#include <libtensor/symmetry/part/so_dirsum_impl_part.h>
...
void so_dirsum_impl_part_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_dirsum_impl_part_test::test_empty_1() throw(libtest::test_exception) {

    static const char *testname =
            "so_dirsum_impl_part_test::test_empty_1()";
 ...
 **/
void so_dirsum_impl_part_test::test_empty_2(
        bool perm) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirsum_impl_part_test::test_empty_2(" << perm << ")";
    ...
    try {
        ...
        if (perm) {
            ...
            elemc.add_map(i001, i100, true);
        }
        else {
            elemc.add_map(i000, i110, true);
            elemc.add_map(i010, i100, true);
        }
 ...
 **/
void so_dirsum_impl_part_test::test_empty_3(
        bool perm) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirsum_impl_part_test::test_empty_3(" << perm << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirsum_impl_part_test::test_nn_1(
        bool symm1, bool symm2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirsum_impl_part_test::test_nn_1(" << symm1 << ", "
            << symm2 << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirsum_impl_part_test::test_nn_2(
        bool symm1, bool symm2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirsum_impl_part_test::test_nn_2(" << symm1 << ", "
            << symm2 << ")";
    std::string tns = tnss.str();
 ...
 **/
void so_dirsum_impl_part_test::test_nn_3(
        bool symm1, bool symm2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_dirsum_impl_part_test::test_nn_3(" << symm1 << ", "
            << symm2 << ")";
    std::string tns = tnss.str();
    ...
    try {
        ...
        elemc.add_map(i0000, i0011, symm2);
