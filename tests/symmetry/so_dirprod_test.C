 ...
 **/
void so_dirprod_test::test_empty_2() throw(libtest::test_exception) {

	static const char *testname = "so_dirprod_test::test_empty_2()";
 ...
 **/
void so_dirprod_test::test_empty_3() throw(libtest::test_exception) {

	static const char *testname = "so_dirprod_test::test_empty_3()";
 ...
 **/
void so_dirprod_test::test_se_2() throw(libtest::test_exception) {

	static const char *testname = "so_dirprod_test::test_se_2()";
 ...
 **/
void so_dirprod_test::test_perm_1() throw(libtest::test_exception) {

	static const char *testname = "so_dirprod_test::test_perm_1()";
 ...
 **/
void so_dirprod_test::test_perm_2() throw(libtest::test_exception) {

    static const char *testname = "so_dirprod_test::test_perm_2()";
