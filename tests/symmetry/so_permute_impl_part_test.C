...
/**	\test Tests permutation of a non-empty set. Permutation does not affect
		the mapping
 **/
void so_permute_impl_part_test::test_2a() throw(libtest::test_exception) {

	static const char *testname = "so_permute_impl_part_test::test_2a()";
...
/**	\test Tests permutation of a non-empty set. Permutation does not affect
		the mapping
 **/
void so_permute_impl_part_test::test_2b() throw(libtest::test_exception) {

	static const char *testname = "so_permute_impl_part_test::test_2b()";
 ...
 **/
void so_permute_impl_part_test::test_3() throw(libtest::test_exception) {

	static const char *testname = "so_permute_impl_part_test::test_3()";
