#ifndef LIBTENSOR_SO_DIRSUM_IMPL_PART_TEST_H
#define LIBTENSOR_SO_DIRSUM_IMPL_PART_TEST_H
 ...
 **/
class so_dirsum_impl_part_test : public libtest::unit_test {
public:
...
#endif // LIBTENSOR_SO_DIRSUM_IMPL_PART_TEST_H
