...
void so_reduce_impl_label_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_reduce_impl_label_test::test_empty_1(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_label_test::test_empty_1(" << table_id << ")";
 ...
 **/
void so_reduce_impl_label_test::test_empty_2(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_label_test::test_empty_2(" << table_id << ")";
    std::string tns(tnss.str());

    typedef se_label<5, double> se5_t;
    typedef se_label<1, double> se1_t;
    typedef so_reduce<5, 4, 2, double> so_reduce_t;
 ...
 **/
void so_reduce_impl_label_test::test_nm1_1(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_label_test::test_nm1_1(" << table_id << ")";
    std::string tns(tnss.str());

    typedef se_label<1, double> se1_t;
    typedef se_label<3, double> se3_t;
    typedef so_reduce<3, 2, 1, double> so_reduce_t;
    typedef symmetry_operation_impl<so_reduce_t, se3_t> so_reduce_impl_t;
    ...
    symmetry_operation_params<so_reduce_t> params(set1, m, set2);
 ...
 **/
void so_reduce_impl_label_test::test_nm1_2(const std::string &table_id,
        bool product) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_label_test::test_nm1_2(" <<
            table_id << ", " << product << ")";
    std::string tns(tnss.str());
    ...
    // [i x 2] [x j 0] = [i 2] [j 0], [i 3] [j 1], [i 0] [j 2], [i 1] [j 3]
    symmetry_element_set<4, double> set1(se4_t::k_sym_type);
    symmetry_element_set<2, double> set2(se2_t::k_sym_type);
 ...
 **/
void so_reduce_impl_label_test::test_nmk_1(
        const std::string &table_id) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_label_test::test_nmk_1(" << table_id << ")";
    std::string tns(tnss.str());
 ...
 **/
void so_reduce_impl_label_test::test_nmk_2(const std::string &table_id,
        bool product) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_label_test::test_nmk_2("
            << table_id << "," << product << ")";
    std::string tns(tnss.str());
