#include <libtensor/symmetry/part/so_reduce_impl_part.h>
...
void so_reduce_impl_part_test::perform() throw(libtest::test_exception) {
...
/**	\test Tests that a projection of an empty group yields an empty group
		of a lower order
 **/
void so_reduce_impl_part_test::test_empty_1() throw(libtest::test_exception) {

    static const char *testname = "so_reduce_impl_part_test::test_empty_1()";

    typedef se_part<4, double> se4_t;
    typedef se_part<2, double> se2_t;
    typedef so_reduce<4, 2, 1, double> so_reduce_t;
    typedef symmetry_operation_impl<so_reduce_t, se4_t> so_reduce_impl_t;
    ...
    try {
        ...
        so_reduce_impl_t().perform(params);
...
/**	\test Tests that a double projection of an empty group yields an empty group
		of a lower order
 **/
void so_reduce_impl_part_test::test_empty_2() throw(libtest::test_exception) {

    static const char *testname = "so_reduce_impl_part_test::test_empty_2()";

    typedef se_part<5, double> se5_t;
    typedef se_part<2, double> se2_t;
    typedef so_reduce<5, 3, 2, double> so_reduce_t;
    typedef symmetry_operation_impl<so_reduce_t, se5_t> so_reduce_impl_t;
 ...
 **/
void so_reduce_impl_part_test::test_nm1_1(bool sign)
throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nm1_1(" << sign << ")";

    typedef se_part<2, double> se2_t;
    typedef se_part<1, double> se1_t;
    typedef so_reduce<2, 1, 1, double> so_reduce_t;
    typedef symmetry_operation_impl<so_reduce_t, se2_t> so_reduce_impl_t;
 ...
 **/
void so_reduce_impl_part_test::test_nm1_2(
        bool s1, bool s2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nm1_2(" << s1 << ", " << s2 << ")";
 ...
 **/
void so_reduce_impl_part_test::test_nm1_3(
        bool sign) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nm1_3("")";
 ...
 **/
void so_reduce_impl_part_test::test_nm1_4(
        bool sign) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nm1_4(" << sign << ")";
 ...
 **/
void so_reduce_impl_part_test::test_nm1_5(
        bool sign) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nm1_5(" << sign << ")";
 ...
 **/
void so_reduce_impl_part_test::test_nm1_6(
        bool sign) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nm1_6(" << sign << ")";
 ...
 **/
void so_reduce_impl_part_test::test_nmk_1(
        bool sign) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nmk_1(" << sign << ")";
 ...
 **/
void so_reduce_impl_part_test::test_nmk_2(
        bool s1, bool s2) throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_reduce_impl_part_test::test_nmk_2(" << s1 << ", " << s2 << ")";

    typedef se_part<6, double> se6_t;
    typedef se_part<2, double> se2_t;
    typedef so_reduce<6, 4, 2, double> so_reduce_t;
    typedef symmetry_operation_impl<so_reduce_t, se6_t> so_reduce_impl_t;
