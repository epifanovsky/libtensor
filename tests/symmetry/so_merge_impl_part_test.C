 ...
 **/
void so_merge_impl_part_test::test_nmk_1(bool sign)
throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_merge_impl_part_test::test_nmk_1(" << sign << ")";
 ...
 **/
void so_merge_impl_part_test::test_nmk_2(bool s1, bool s2)
throw(libtest::test_exception) {

    std::ostringstream tnss;
    tnss << "so_merge_impl_part_test::test_nmk_2(" << s1 << ", " << s2 << ")";
