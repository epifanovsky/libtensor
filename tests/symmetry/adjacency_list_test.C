...
int test_1() {
    ...
    try {
        ...
        if (! alst.exist(0, 1)) {
            return fail_test(testname, __FILE__, __LINE__, "Edge 0-1");
        }
        if (! alst.exist(1, 4)) {
            return fail_test(testname, __FILE__, __LINE__, "Edge 1-4");
        }
        if (alst.exist(0, 4)) {
            return fail_test(testname, __FILE__, __LINE__, "Edge 0-4");
        }


        if (alst.weight(0, 1) != 3) {
            return fail_test(testname, __FILE__, __LINE__, "Weight 0-1");
        }
        if (alst.weight(1, 4) != 2) {
            return fail_test(testname, __FILE__, __LINE__, "Weight 1-4");
        }
        if (alst.weight(0, 4) != 0) {
            return fail_test(testname, __FILE__, __LINE__, "Weight 0-4");
        }
...
int test_2() {
    ...
    try {
        ...
        if (prev0.size() != 0) {
            return fail_test(testname, __FILE__, __LINE__, "# prev(0)");
        }

        alst.get_prev_neighbours(3, prev3);
        if (prev3.size() != 3) {
            return fail_test(testname, __FILE__, __LINE__, "# prev(3)");
        }
        ...
        if (prev6.size() != 4) {
            return fail_test(testname, __FILE__, __LINE__, "# prev(6)");
        }
        ...
        if (next2.size() != 2) {
            return fail_test(testname, __FILE__, __LINE__, "# next(2)");
        }
        ...
        if (next4.size() != 0) {
            return fail_test(testname, __FILE__, __LINE__, "# next(4)");
        }

        alst.get_next_neighbours(5, next5);
        if (next5.size() != 1) {
            return fail_test(testname, __FILE__, __LINE__, "# next(5)");
        }
        if (next5[0] != 6) {
            return fail_test(testname, __FILE__, __LINE__, "next(5)");
        }
        ...
        if (nb2.size() != 3) {
            return fail_test(testname, __FILE__, __LINE__, "# neighbours(2)");
        }
        ...
        if (nb4.size() != 2) {
            return fail_test(testname, __FILE__, __LINE__, "# neighbours(4)");
        }
        if (nb4[0] != 1 || nb4[1] != 3) {
            return fail_test(testname, __FILE__, __LINE__, "neighbours(4)");
        }
        ...
        if (nb7.size() != 0) {
            return fail_test(testname, __FILE__, __LINE__, "# neighbours(7)");
        }
...
int test_3() {
    ...
    try {
        ...
        if (conn0.size() != 5) {
            return fail_test(testname, __FILE__, __LINE__, "# connected(0)");
        }
        alst.get_connected(8, conn8);
        if (conn8.size() != 5) {
            return fail_test(testname, __FILE__, __LINE__, "# connected(8)");
        }
        ...
        if (conn3.size() != 5) {
            return fail_test(testname, __FILE__, __LINE__, "# connected(3)");
        }
        alst.get_connected(7, conn7);
        if (conn7.size() != 5) {
            return fail_test(testname, __FILE__, __LINE__, "# connected(7)");
        }
        for (size_t i = 0; i < 5; i++) {
            if (conn3[i] != conn7[i]) {
                return fail_test(testname, __FILE__, __LINE__,
        ...
        if (conn10.size() != 0) {
            return fail_test(testname, __FILE__, __LINE__, "# connected(10)");
        }
