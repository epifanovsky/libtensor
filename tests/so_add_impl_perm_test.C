#include <libtensor/symmetry/so_add_impl_perm.h>
...
void so_add_impl_perm_test::perform() throw(libtest::test_exception) {
 ...
 **/
void so_add_impl_perm_test::test_1() throw(libtest::test_exception) {

	static const char *testname = "so_add_impl_perm_test::test_1()";
...
/**	\test Tests that the intersection of an empty set and a non-empty set
		yields an empty set
 **/
void so_add_impl_perm_test::test_2() throw(libtest::test_exception) {

	static const char *testname = "so_add_impl_perm_test::test_2()";
...
/**	\test Tests that the intersection of two non-overlapping non-empty sets
		yields an empty set
 **/
void so_add_impl_perm_test::test_3() throw(libtest::test_exception) {

	static const char *testname = "so_add_impl_perm_test::test_3()";
 ...
 **/
void so_add_impl_perm_test::test_4() throw(libtest::test_exception) {

	static const char *testname = "so_add_impl_perm_test::test_4()";
