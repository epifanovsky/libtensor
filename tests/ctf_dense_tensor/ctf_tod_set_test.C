...
void ctf_tod_set_test::test_1() {

    static const char testname[] = "ctf_tod_set_test::test_1()";
...
void ctf_tod_set_test::test_2() {

    static const char testname[] = "ctf_tod_set_test::test_2()";
