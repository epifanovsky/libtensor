 ...
 **/
void permutation_group_test::test_2() throw(libtest::test_exception) {

	static const char *testname = "permutation_group_test::test_2()";
...
void permutation_group_test::test_4() throw(libtest::test_exception) {
	...
	typedef se_perm<4, double> se_perm_t;
	std::cout << std::endl << "test_4" << std::endl;
