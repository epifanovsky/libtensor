 ...
 **/
void so_add_impl_label_test::test_2a(
		bool elem_in_b) throw(libtest::test_exception) {
 ...
 **/
void so_add_impl_label_test::test_2b(
		bool elem_in_a) throw(libtest::test_exception) {
...
void so_add_impl_label_test::test_3b() throw(libtest::test_exception) {
	...
	se2_t elem2_1(bis2.get_block_index_dims(), table_id);
...
void so_add_impl_label_test::test_4() throw(libtest::test_exception) {
	...
	se2_t elem2_1(bis2.get_block_index_dims(), table_id);
	se2_t elem2_2(bis2.get_block_index_dims(), table_id);
...
void so_add_impl_label_test::test_5a() throw(libtest::test_exception) {
	...
	se3_t elem3_1(bis3.get_block_index_dims(), table_id);
	se3_t elem3_2(bis3.get_block_index_dims(), table_id);
