#ifndef LIBTENSOR_TOD_CUDA_COPY_TEST_H
#define LIBTENSOR_TOD_CUDA_COPY_TEST_H
...
/**	\brief Tests the libtensor::tod_cuda_copy class

	\ingroup libtensor_tests_tod
**/
class tod_cuda_copy_test : public libtest::unit_test {
public:
...
#endif // LIBTENSOR_TOD_CUDA_COPY_TEST_H
