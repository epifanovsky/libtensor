...
void cuda_tod_contract2_test::perform() throw(libtest::test_exception) {
...
void cuda_tod_contract2_test::test_i_p_pi(size_t ni, size_t np, double d)
    throw(libtest::test_exception) {

    //  c_i = \sum_p a_p b_{pi}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_i_p_pi(" << ni << ", " << np << ", "
        << d << ")";
...
void cuda_tod_contract2_test::test_i_p_ip(size_t ni, size_t np, double d)
    throw(libtest::test_exception) {

    //    c_i = \sum_p a_p b_{ip}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_i_p_ip(" << ni << ", " << np << ", "
        << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_i_pi_p(size_t ni, size_t np, double d)
    throw(libtest::test_exception) {

    //    c_i = \sum_p a_{pi} b_p

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_i_pi_p(" << ni << ", " << np << ", "
        << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_i_ip_p(size_t ni, size_t np, double d)
    throw(libtest::test_exception) {

    //    c_i = \sum_p a_{ip} b_p

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_i_ip_p(" << ni << ", " << np << ", "
        << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_i_j(size_t ni, size_t nj, double d)
    throw(libtest::test_exception) {

    //    c_{ij} = c_{ij} + d a_{i} b_{j}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_i_j(" << ni << ", " << nj
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_j_i(size_t ni, size_t nj, double d)
    throw(libtest::test_exception) {

    //    c_{ij} = c_{ij} + d a_{j} b_{i}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_j_i(" << ni << ", " << nj
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pi_pj(
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pi_pj(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
    ...
    dimensions<2> dimb(index_range<2>(ib1, ib2));
    dimensions<2> dimc(index_range<2>(ic1, ic2));
    size_t sza = dima.get_size(), szb = dimb.get_size(), szc = dimc.get_size();
    ...
    dense_tensor_wr_ctrl<2, double> tcb(tb);
    dense_tensor_wr_ctrl<2, double> tcc(tc);
    dense_tensor_wr_ctrl<2, double> tcc_ref(tc_ref);
    double *dta = tca.req_dataptr();
    double *dtb = tcb.req_dataptr();
    double *dtc1 = tcc.req_dataptr();
    double *dtc2 = tcc_ref.req_dataptr();
    ...
    contr.contract(0, 0);
    if(d == 0.0) {
        cuda_tod_contract2<1, 1, 1>(contr, cuta, cutb, 1.0).perform(true, cutc);
    } else {
        cuda_tod_contract2<1, 1, 1>(contr, cuta, cutb, d).perform(false, cutc);
    }
...
void cuda_tod_contract2_test::test_ij_pi_jp(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pi_jp(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_ip_pj(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_ip_pj(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_ip_jp(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_ip_jp(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pj_pi(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pj_pi(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pj_ip(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pj_ip(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_jp_ip(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_jp_ip(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_jp_pi(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_jp_pi(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_p_pji(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_p_pji(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pji_p(
    size_t ni, size_t nj, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pji_p(" << ni << ", " << nj
        << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pi_pj_qi_jq(
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pi_pj_qi_jq(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pi_pj_qi_qj(
    size_t ni, size_t nj, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pi_pj_qi_qj(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_ip_pkj(
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_ip_pkj(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pi_pkj(
    size_t ni, size_t nj, size_t nk, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pi_pkj(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pik_pj(
    size_t ni, size_t nj, size_t nk, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pik_pj(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pj_ipk(
    size_t ni, size_t nj, size_t nk, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pj_ipk(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pj_pik(
    size_t ni, size_t nj, size_t nk, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pj_pik(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pkj_ip(
    size_t ni, size_t nj, size_t nk, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pkj_ip(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pkj_pi(
    size_t ni, size_t nj, size_t nk, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pkj_pi(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pqi_pjq(
    size_t ni, size_t nj, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pqi_pjq(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_ipq_jqp(
    size_t ni, size_t nj, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_ipq_jqp(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_jpq_iqp(
    size_t ni, size_t nj, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_jpq_iqp(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_jipq_qp(
    size_t ni, size_t nj, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_jipq_qp(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pq_ijpq(size_t ni, size_t nj, size_t np,
    size_t nq) throw(libtest::test_exception) {

    // c_{ij} = \sum_{pq} a_{pq} b_{ijpq}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pq_ijpq(" << ni << ", " << nj
        << ", " << np << ", " << nq << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pq_ijpq_a(size_t ni, size_t nj, size_t np,
    size_t nq, double d) throw(libtest::test_exception) {

    // c_{ij} = c_{ij} + d \sum_{pq} a_{pq} b_{ijpq}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pq_ijpq_a(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_kjpq_iqp(size_t ni, size_t nj, size_t nk,
    size_t np, size_t nq, double d) throw(libtest::test_exception) {

    //    c_{ijk} = \sum_{pq} a_{kjpq} b_{iqp}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_kjpq_iqp(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pkiq_pjq(size_t ni, size_t nj, size_t nk,
    size_t np, size_t nq, double d) throw(libtest::test_exception) {

    //    c_{ijk} = c_{ijk} + d \sum_{pq} a_{pkiq} b_{pjq}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pkiq_pjq(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pqj_iqpk(size_t ni, size_t nj, size_t nk,
    size_t np, size_t nq, double d) throw(libtest::test_exception) {

    //    c_{ijk} = \sum_{pq} a_{pqj} b_{iqpk}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pqj_iqpk(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijk_pqji_qpk(size_t ni, size_t nj, size_t nk,
    size_t np, size_t nq, double d) throw(libtest::test_exception) {

    //    c_{ijk} = \sum_{pq} a_{pqji} b_{qpk}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijk_pqji_qpk(" << ni << ", " << nj
        << ", " << nk << ", " << np << ", " << nq << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ikp_jpl(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    //    c_{ijkl} = c_{ijkl} + d \sum_{p} a_{ikp} b_{jpl}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ikp_jpl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ipk_jpl(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    //    c_{ijkl} = c_{ijkl} + d \sum_{p} a_{ikp} b_{jpl}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ipk_jpl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ipl_jpk(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    //    c_{ijkl} = c_{ijkl} + d \sum_{p} a_{ipl} b_{jpk}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ipl_jpk(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_jkp_ipl(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    //    c_{ijkl} = c_{ijkl} + d \sum_{p} a_{jkp} b_{ipl}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_jkp_ipl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_jpl_ipk(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    //    c_{ijkl} = c_{ijkl} + d \sum_{p} a_{jpl} b_{ipk}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_jpl_ipk(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_jpl_ipk_jiq_kql_jlr_ikr(size_t ni, size_t nj,
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_jpl_ipk_jiq_kql_jlr_ikr("
        << ni << ", " << nj << ", " << nk << ", " << nl << ", " << np << ", "
        << nq << ", " << nr << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijklm_ikp_jpml(size_t ni, size_t nj, size_t nk,
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijklm_ikp_jpml(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << nm << ", " << np
        << ", "  << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijklm_ipkm_jpl(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t nm, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijklm_ipkm_jpl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << nm << ", " << np
        << ", "  << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijklm_jlp_ipkm(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t nm, size_t np, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijklm_jlp_ipkm(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << nm << ", " << np
        << ", "  << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijklmn_kjmp_ipln(size_t ni, size_t nj, size_t nk,
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijklmn_kjmp_ipln(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << nm << ", " << nn
        << ", "  << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_iplq_kpjq(size_t ni, size_t nj, size_t nk,
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_iplq_kpjq(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_iplq_pkjq(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_iplq_pkjq(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_iplq_pkqj(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_iplq_pkqj(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ipql_kpqj(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ipql_kpqj(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ipql_pkqj(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ipql_pkqj(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_pilq_kpjq(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_pilq_kpjq(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_pilq_pkjq(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_pilq_pkjq(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_piql_kpqj(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_piql_kpqj(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_piql_pkqj(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_piql_pkqj(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_pqkj_iqpl(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_pqkj_iqpl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_pqkj_qipl(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, size_t nq, double d)
    throw(libtest::test_exception) {
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_pqkj_qipl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << nq
        << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_ipqr_jpqr(size_t ni, size_t nj, size_t np,
    size_t nq, size_t nr) throw(libtest::test_exception) {

    // c_{ij} = \sum_{pqr} a_{ipqr} b_{jpqr}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_ipqr_jpqr(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << nr << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_ipqr_jpqr_a(size_t ni, size_t nj, size_t np,
    size_t nq, size_t nr, double d) throw(libtest::test_exception) {

    // c_{ij} = c_{ij} + d \sum_{pqr} a_{ipqr} b_{jpqr}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_ipqr_jpqr_a(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << nr << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_ipqr_pjrq(
    ...
    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_ipqr_pjrq(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << nr << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_jpqr_iprq(size_t ni, size_t nj, size_t np,
    size_t nq, size_t nr, double d) throw(libtest::test_exception) {

    // c_{ij} = c_{ij} + d \sum_{pqr} a_{jpqr} b_{iprq}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_jpqr_iprq(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << nr << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pqir_pqjr(size_t ni, size_t nj,
    size_t np, size_t nq, size_t nr) throw(libtest::test_exception) {

    // c_{ij} = \sum_{pqr} a_{pqir} b_{pqjr}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pqir_pqjr(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << nr << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ij_pqir_pqjr_a(size_t ni, size_t nj, size_t np,
    size_t nq, size_t nr, double d) throw(libtest::test_exception) {

    // c_{ij} = c_{ij} + d \sum_{pqr} a_{pqir} b_{pqjr}

    std::stringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ij_pqir_pqjr_a(" << ni << ", " << nj
        << ", " << np << ", " << nq << ", " << nr << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_pi_jklp(size_t ni, size_t nj,
    ...
    tnss << "cuda_tod_contract2_test::test_ijkl_pi_jklp(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ")";
...
void cuda_tod_contract2_test::test_ijkl_pi_jklp_a(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {
    ...
    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_pi_jklp_a(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
...
void cuda_tod_contract2_test::test_jikl_pi_jpkl(size_t ni, size_t nj,
    size_t nk, size_t nl, size_t np) throw(libtest::test_exception) {

    // c_{jikl} = \sum_p a_{pi} b_{jpkl}

    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_jikl_pi_jpkl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_jikl_pi_jpkl_a(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    // c_{jikl} = c_{jikl} + d \sum_p a_{pi} b_{jpkl}

    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_jikl_pi_jpkl_a(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ijp_klp(size_t ni, size_t nj,
    size_t nk, size_t nl, size_t np) throw(libtest::test_exception) {

    // c_{ijkl} = \sum_{p} a_{ijp} b_{klp}

    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ijp_klp(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ijp_klp_a(size_t ni, size_t nj, size_t nk,
    size_t nl, size_t np, double d) throw(libtest::test_exception) {

    // c_{ijkl} = c_{ijkl} + d \sum_{p} a_{ijp} b_{klp}

    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ijp_klp_a(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ", " << np << ", " << d << ")";
    std::string tns = tnss.str();
...
void cuda_tod_contract2_test::test_ijkl_ij_kl(size_t ni, size_t nj,
    ...
    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ij_kl(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ")";
...
void cuda_tod_contract2_test::test_ijkl_ij_lk(size_t ni, size_t nj,
    size_t nk, size_t nl) throw(libtest::test_exception) {
    ...
    std::ostringstream tnss;
    tnss << "cuda_tod_contract2_test::test_ijkl_ij_lk(" << ni << ", " << nj
        << ", " << nk << ", " << nl << ")";
