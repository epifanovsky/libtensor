#ifndef LIBTENSOR_CUDA_TOD_ADD_TEST_H
#define LIBTENSOR_CUDA_TOD_ADD_TEST_H
...
/** \brief Tests the libtensor::cuda_tod_add class

    \ingroup libtensor_tests_tod
**/
class cuda_tod_add_test : public libtest::unit_test {
public:
...
#endif // LIBTENSOR_CUDA_TOD_ADD_TEST_H
