#ifndef LIBTENSOR_CUDA_TOD_CONTRACT2_TEST_H
#define LIBTENSOR_CUDA_TOD_CONTRACT2_TEST_H
...
/** \brief Tests the libtensor::cuda_tod_contract2 class

    \ingroup libtensor_cuda_dense_tensor_tests
**/
class cuda_tod_contract2_test : public libtest::unit_test {
private:
...
#endif // LIBTENSOR_CUDA_TOD_CONTRACT2_TEST_H
