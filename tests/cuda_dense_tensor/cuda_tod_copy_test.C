...
template<size_t N>
void cuda_tod_copy_test::test_plain(const dimensions<N> &dims)
    throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_plain()";
...
template<size_t N>
void cuda_tod_copy_test::test_plain_additive(const dimensions<N> &dims, double d)
    throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_plain_additive()";
...
template<size_t N>
void cuda_tod_copy_test::test_scaled(const dimensions<N> &dims, double c)
    throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_scaled()";
    ...
    std::ostringstream ss; ss << "cuda_tod_copy_test::test_scaled(" << c << ")";
...
template<size_t N>
void cuda_tod_copy_test::test_scaled_additive(const dimensions<N> &dims, double c,
    double d) throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_scaled_additive()";
    ...
    std::ostringstream ss; ss << "cuda_tod_copy_test::test_scaled_additive("
        << c << ")";
    compare_ref<N>::compare(ss.str().c_str(), h_tb, h_tb_ref, 1e-15);
...
template<size_t N>
void cuda_tod_copy_test::test_perm(const dimensions<N> &dims,
    const permutation<N> &perm) throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_perm()";
...
template<size_t N>
void cuda_tod_copy_test::test_perm_additive(const dimensions<N> &dims,
    const permutation<N> &perm, double d) throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_perm_additive()";
...
template<size_t N>
void cuda_tod_copy_test::test_perm_scaled(const dimensions<N> &dims,
    const permutation<N> &perm, double c) throw(libtest::test_exception) {

    static const char *testname = "cuda_tod_copy_test::test_perm_scaled()";
...
template<size_t N>
void cuda_tod_copy_test::test_perm_scaled_additive(const dimensions<N> &dims,
    const permutation<N> &perm, double c, double d)
    throw(libtest::test_exception) {

    static const char *testname =
        "cuda_tod_copy_test::test_perm_scaled_additive()";
...
void cuda_tod_copy_test::test_exc() throw(libtest::test_exception) {
    index<4> i1, i2, i3;
    ...
    bool ok = false;
    try {
        cuda_tod_copy<4> tc(t1); tc.perform(t2);
    } catch(exception &e) {
        ok = true;
    }

    if(!ok) {
        fail_test("cuda_tod_copy_test::test_exc()", __FILE__, __LINE__,
