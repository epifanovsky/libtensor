...
#include <libtensor/cuda_block_tensor/cuda_direct_block_tensor.h>
...
#include "cuda_direct_block_tensor_test.h"

namespace libtensor {


void cuda_direct_block_tensor_test::perform() throw(libtest::test_exception) {
 ...
 **/
void cuda_direct_block_tensor_test::test_op_1() {

    static const char *testname = "cuda_direct_block_tensor_test::test_op_1()";
    ...
    cuda_block_tensor<2, double, cuda_allocator_type> bta_d(bis);
    btod_random<2>().perform(bta);
    bta.set_immutable();


    btod_copy<2> op_copy(bta);
    direct_block_tensor<2, double, allocator_type> btb_ref(op_copy);
    direct_block_tensor<2, double, allocator_type> btb_ref(op_copy);

    cuda_btod_copy<2> op_copy_d(bta_d);
    cuda_direct_block_tensor<2, double, cuda_allocator_type> btb_d(op_copy_d);
...
/** \test Installs a simple copy operation in a direct block %tensor
        (multiple blocks).
 **/
void cuda_direct_block_tensor_test::test_op_2() {

    static const char *testname = "cuda_direct_block_tensor_test::test_op_2()";
...
/** \test Installs a copy operation in a direct block %tensor and runs
        a contraction.
 **/
void cuda_direct_block_tensor_test::test_op_3() {

    static const char *testname = "cuda_direct_block_tensor_test::test_op_3()";
 ...
 **/
void cuda_direct_block_tensor_test::test_op_4() {

    static const char *testname = "cuda_direct_block_tensor_test::test_op_4()";
 ...
 **/
void cuda_direct_block_tensor_test::test_op_5() {

    static const char *testname = "cuda_direct_block_tensor_test::test_op_5()";
...
/** \test Tests recursive use of direct block tensors
 **/
void cuda_direct_block_tensor_test::test_op_6() {

    static const char *testname = "cuda_direct_block_tensor_test::test_op_6()";
