...
#include <libtensor/block_sparse/block_kernel_add2.h>
...
void block_kernels_test::test_block_kernel_contract2_2d_no_contracted_inds() throw(libtest::test_exception)
{
    ...
    vector<sparse_bispace_impl> bispaces(1,spb_i|spb_j|spb_k);
    ...
    ts_groups[0].push_back(idx_pair(2,1));
    //j loop
    ts_groups[1].push_back(idx_pair(0,1));
    ...
    ts_groups[2].push_back(idx_pair(1,2));
    ts_groups[2].push_back(idx_pair(2,2));
...
void block_kernels_test::test_block_kernel_contract2_2d_strided_output() throw(libtest::test_exception)
{
    ...
    vector<sparse_bispace_impl> bispaces(1,spb_j|spb_i);
    bispaces.push_back(spb_i|spb_k);
    bispaces.push_back(spb_k|spb_j);
...
void block_kernels_test::test_block_kernel_contract2_perm_A_ikj() throw(libtest::test_exception)
{
    ...
    //j loop
    ts_groups[1].push_back(idx_pair(0,1));
    ts_groups[1].push_back(idx_pair(1,2));
    //l loop
    ts_groups[2].push_back(idx_pair(0,2));
    ts_groups[2].push_back(idx_pair(2,1));
    //k loop
    ts_groups[3].push_back(idx_pair(1,1));
...
void block_kernels_test::test_block_kernel_contract2_2d_ki_kj() throw(libtest::test_exception)
{
    ...
    ts_groups[1].push_back(idx_pair(2,1));
    //k loop
    ts_groups[2].push_back(idx_pair(1,0));
    ts_groups[2].push_back(idx_pair(2,0));
...
void block_kernels_test::test_block_kernel_contract2_2d_ki_kj_permuted_loops() throw(libtest::test_exception)
{
    ...
    //k loop
    ts_groups[0].push_back(idx_pair(1,0));
    ts_groups[0].push_back(idx_pair(2,0));
    //i loop
    ts_groups[1].push_back(idx_pair(0,0));
    ts_groups[1].push_back(idx_pair(1,1));
    //j loop
    ts_groups[2].push_back(idx_pair(0,1));
    ts_groups[2].push_back(idx_pair(2,1));
...
void block_kernels_test::test_block_kernel_contract2_3d_3d_multi_index() throw(libtest::test_exception)
{
    ...
    vector<sparse_bispace_impl> bispaces(1,spb_i|spb_l);
    bispaces.push_back(spb_i|spb_j|spb_k);
    ...
    //k loop
    ts_groups[3].push_back(idx_pair(1,2));
    ts_groups[3].push_back(idx_pair(2,2));
...
void block_kernels_test::test_block_kernel_contract2_2d_3d_permute_output() throw(libtest::test_exception)
{
    ...
    ts_groups[2].push_back(idx_pair(2,2));
    //k loop
    ts_groups[3].push_back(idx_pair(1,0));
    ts_groups[3].push_back(idx_pair(2,1));
...
void block_kernels_test::test_block_kernel_add2_3d() throw(libtest::test_exception)
{
    static const char *test_name = "block_kernels_test::test_block_kernel_add2_3d()";
    ...
    block_kernel_add2<double> ba2k(1,-0.5);
    ba2k(ptrs,dim_lists);
    ...
    for(size_t i = 0; i < 6 ; ++i)
    {
        ...
        {
			fail_test(test_name,__FILE__,__LINE__,
					"block_kernel_add2::operator(...) returned incorrect output");
        }
    }
}
