...
void tod_apply_test::test_plain_additive(Functor &fn,
	...
	tod_apply<N, Functor> cp(ta, fn, tr1, tr2);
	cp.perform(false, tb);
...
void tod_apply_test::test_scaled(Functor &fn,
	...
	permutation<N> p;
    tensor_transf<N, double> tr1(p, scalar_transf<double>(c));
    tensor_transf<N, double> tr2;
	tod_apply<N, Functor> cp(ta, fn, tr1, tr2);
	cp.perform(true, tb);
...
void tod_apply_test::test_perm(Functor &fn, const dimensions<N> &dims,
    ...
    tensor_transf<N, double> tr1(perm), tr2;
...
void tod_apply_test::test_perm_additive(Functor &fn, const dimensions<N> &dims,
	...
	permutation<N> p;
    tensor_transf<N, double> tr1(perm), tr2(p, scalar_transf<double>(d));
	tod_apply<N, Functor> cp(ta, fn, tr1, tr2);
	cp.perform(false, tb);
...
void tod_apply_test::test_perm_scaled(Functor &fn, const dimensions<N> &dims,
	...
	tensor_transf<N, double> tr1(perm, scalar_transf<double>(c)), tr2;
	tod_apply<N, Functor> cp(ta, fn, tr1, tr2);
	cp.perform(true, tb);
...
void tod_apply_test::test_perm_scaled_additive(Functor &fn,
	...
	permutation<N> p;
    tensor_transf<N, double> tr1(perm, scalar_transf<double>(c));
    tensor_transf<N, double> tr2(p, scalar_transf<double>(d));
	tod_apply<N, Functor> cp(ta, fn, tr1, tr2);
	cp.perform(false, tb);
