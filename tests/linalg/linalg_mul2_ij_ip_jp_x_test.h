#ifndef LIBTENSOR_LINALG_MUL2_IJ_IP_JP_X_TEST_H
#define LIBTENSOR_LINALG_MUL2_IJ_IP_JP_X_TEST_H
 ...
 **/
class linalg_mul2_ij_ip_jp_x_test : public linalg_test_base {
public:
...
#endif // LIBTENSOR_LINALG_MUL2_IJ_IP_JP_X_TEST_H
