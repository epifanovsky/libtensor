...
void linalg_ijkl_ipl_kpj_x_test::perform() throw(libtest::test_exception) {

	test_ijkl_ipl_kpj_x(1, 1, 1, 1, 1);
	test_ijkl_ipl_kpj_x(2, 1, 1, 1, 1);
	test_ijkl_ipl_kpj_x(1, 2, 1, 1, 1);
	test_ijkl_ipl_kpj_x(1, 1, 2, 1, 1);
	test_ijkl_ipl_kpj_x(1, 1, 1, 2, 1);
	test_ijkl_ipl_kpj_x(1, 1, 1, 1, 2);
	test_ijkl_ipl_kpj_x(2, 3, 2, 3, 2);
	test_ijkl_ipl_kpj_x(3, 5, 1, 7, 13);
	test_ijkl_ipl_kpj_x(16, 16, 16, 16, 16);
	test_ijkl_ipl_kpj_x(17, 16, 17, 16, 17);
}


void linalg_ijkl_ipl_kpj_x_test::test_ijkl_ipl_kpj_x(size_t ni, size_t nj,
	size_t nk, size_t nl, size_t np) throw(libtest::test_exception) {

	std::ostringstream ss;
	ss << "linalg_ijkl_ipl_kpj_x_test::test_ijkl_ipl_kpj_x("
		<< ni << ", " << nj << ", " << nk << ", " << nl << ", "
		<< np << ")";
