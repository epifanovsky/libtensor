...
int test_mul2_i_i_i_x(size_t ni, size_t sia, size_t sib, size_t sic, double d) {
  ...
  ss << "test_mul2_i_i_i_x(" << ni << ", " << sia << ", " << sib << ", " << sic << ", "
     << d << ")";
  ...
  try {
    ...
    linalg_generic::mul2_i_i_i_x(0, ni, &a[0], sia, &b[0], sib, &c_ref[0], sic, d);
...
int main() {
  ...
  return
        ...
        test_mul2_i_i_i_x(1, 1, 1, 1, 0.5) | test_mul2_i_i_i_x(2, 1, 1, 1, 1.0) |
        test_mul2_i_i_i_x(16, 1, 1, 1, -1.5) | test_mul2_i_i_i_x(17, 1, 1, 1, 1.0) |
        test_mul2_i_i_i_x(1024, 1, 1, 1, 0.4) | test_mul2_i_i_i_x(1031, 1, 1, 1, 1.2) |
        test_mul2_i_i_i_x(2, 2, 3, 1, -6.0) | test_mul2_i_i_i_x(2, 3, 1, 2, 0.1) |
