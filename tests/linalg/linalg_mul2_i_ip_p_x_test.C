...
int test_mul2_i_ip_p_x(size_t ni, size_t np, size_t sia, size_t sic, size_t spb) {

  std::ostringstream ss;
  ss << "test_mul2_i_ip_p_x(" << ni << ", " << np << ", " << sia << ", " << sic << ", "
     << spb << ")";
  ...
  try {
    ...
    linalg_generic::mul2_i_ip_p_x(0, ni, np, &a[0], sia, &b[0], spb, &c_ref[0], sic, d);
...
int main() {
  ...
  return
        ...
        test_mul2_i_ip_p_x(1, 1, 1, 1, 1) | test_mul2_i_ip_p_x(1, 2, 2, 1, 1) |
        test_mul2_i_ip_p_x(2, 1, 1, 1, 1) | test_mul2_i_ip_p_x(16, 16, 16, 1, 1) |
        test_mul2_i_ip_p_x(17, 3, 3, 1, 1) | test_mul2_i_ip_p_x(2, 2, 2, 3, 4) |
