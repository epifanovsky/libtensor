...
void linalg_ij_ip_pj_x_test::perform() throw(libtest::test_exception) {

    test_ij_ip_pj_x(1, 1, 1, 1, 1, 1);
    test_ij_ip_pj_x(1, 2, 3, 3, 2, 2);
    test_ij_ip_pj_x(2, 1, 3, 3, 1, 1);
    test_ij_ip_pj_x(16, 16, 1, 1, 16, 16);
    test_ij_ip_pj_x(3, 17, 2, 2, 17, 17);
    test_ij_ip_pj_x(2, 2, 2, 2, 3, 4);
    test_ij_ip_pj_x(2, 2, 2, 4, 3, 2);
}


void linalg_ij_ip_pj_x_test::test_ij_ip_pj_x(size_t ni, size_t nj, size_t np,
    size_t sia, size_t sic, size_t spb) throw(libtest::test_exception) {

    std::ostringstream ss;
    ss << "linalg_ij_ip_pj_x_test::test_ij_ip_pj_x("
        << ni << ", " << nj << ", " << np << ", " << sia << ", "
        << sic << ", " << spb << ")";
