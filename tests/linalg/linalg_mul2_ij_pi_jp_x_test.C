...
int test_mul2_ij_pi_jp_x(size_t ni, size_t nj, size_t np, size_t sic, size_t sjb,
                         size_t spa) {

  std::ostringstream ss;
  ss << "test_mul2_ij_pi_jp_x(" << ni << ", " << nj << ", " << np << ", " << sic << ", "
     << sjb << ", " << spa << ")";
  ...
  try {
    ...
    d = 0.0;
    linalg::mul2_ij_pi_jp_x(0, ni, nj, np, &a[0], spa, &b[0], sjb, &c[0], sic, d);
    linalg_generic::mul2_ij_pi_jp_x(0, ni, nj, np, &a[0], spa, &b[0], sjb, &c_ref[0], sic,
                                    d);
...
int main() {
  ...
  return
        ...
        test_mul2_ij_pi_jp_x(1, 1, 1, 1, 1, 1) | test_mul2_ij_pi_jp_x(1, 2, 3, 2, 3, 1) |
        test_mul2_ij_pi_jp_x(2, 1, 3, 1, 3, 2) |
        test_mul2_ij_pi_jp_x(16, 16, 1, 16, 1, 16) |
        test_mul2_ij_pi_jp_x(3, 17, 2, 17, 2, 3) |
        test_mul2_ij_pi_jp_x(2, 2, 2, 2, 3, 4) | test_mul2_ij_pi_jp_x(2, 2, 2, 4, 3, 2) |
