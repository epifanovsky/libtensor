...
void linalg_ijkl_piql_pkqj_x_test::perform() throw(libtest::test_exception) {
...
void linalg_ijkl_piql_pkqj_x_test::test_ijkl_piql_pkqj_x(size_t ni, size_t nj,
	size_t nk, size_t nl, size_t np, size_t nq)
	throw(libtest::test_exception) {

	std::ostringstream ss;
	ss << "linalg_ijkl_piql_pkqj_x_test::test_ijkl_piql_pkqj_x("
		<< ni << ", " << nj << ", " << nk << ", " << nl << ", "
		<< np << ", " << nq << ")";
