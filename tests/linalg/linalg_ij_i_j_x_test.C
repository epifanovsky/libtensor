...
void linalg_ij_i_j_x_test::perform() throw(libtest::test_exception) {
...
void linalg_ij_i_j_x_test::test_ij_i_j_x(size_t ni, size_t nj, size_t sia,
    ...
    d = 0.0;
    linalg::mul2_ij_i_j_x(ni, nj, a, sia, b, sjb, c, sic, d);
    linalg_generic::mul2_ij_i_j_x(ni, nj, a, sia, b, sjb, c_ref, sic, d);
