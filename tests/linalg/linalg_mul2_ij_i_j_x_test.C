...
int test_mul2_ij_i_j_x(size_t ni, size_t nj, size_t sia, size_t sic, size_t sjb) {

  std::ostringstream ss;
  ss << "test_mul2_ij_i_j_x(" << ni << ", " << nj << ", " << sia << ", " << sic << ", "
     << sjb << ")";
  ...
  try {
    ...
    linalg_generic::mul2_ij_i_j_x(0, ni, nj, &a[0], sia, &b[0], sjb, &c_ref[0], sic, d);
...
int main() {
  ...
  return
        ...
        test_mul2_ij_i_j_x(1, 1, 1, 1, 1) | test_mul2_ij_i_j_x(1, 2, 1, 2, 1) |
        test_mul2_ij_i_j_x(2, 1, 1, 1, 1) | test_mul2_ij_i_j_x(16, 16, 1, 16, 1) |
        test_mul2_ij_i_j_x(3, 17, 1, 17, 1) | test_mul2_ij_i_j_x(2, 2, 2, 3, 4) |
