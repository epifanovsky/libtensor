...
void linalg_mul2_ij_i_j_x_test::perform() throw(libtest::test_exception) {
...
void linalg_mul2_ij_i_j_x_test::test_mul2_ij_i_j_x(size_t ni, size_t nj,
    size_t sia, size_t sic, size_t sjb) {

    std::ostringstream ss;
    ss << "linalg_mul2_ij_i_j_x_test::test_mul2_ij_i_j_x("
        << ni << ", " << nj << ", " << sia << ", " << sic << ", " << sjb << ")";
