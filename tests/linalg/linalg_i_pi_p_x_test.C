...
void linalg_i_pi_p_x_test::perform() throw(libtest::test_exception) {
...
void linalg_i_pi_p_x_test::test_i_pi_p_x(size_t ni, size_t np, size_t sic,
    size_t spa, size_t spb) throw(libtest::test_exception) {

    std::ostringstream ss;
    ss << "linalg_i_pi_p_x_test::test_i_pi_p_x("
        << ni << ", " << np << ", " << sic << ", " << spa << ", "
        << spb << ")";
    ...
    d = 0.0;
    linalg::mul2_i_pi_p_x(ni, np, a, spa, b, spb, c, sic, d);
    linalg_generic::mul2_i_pi_p_x(ni, np, a, spa, b, spb, c_ref, sic, d);
