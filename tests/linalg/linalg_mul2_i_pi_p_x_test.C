...
int test_mul2_i_pi_p_x(size_t ni, size_t np, size_t sic, size_t spa, size_t spb) {

  std::ostringstream ss;
  ss << "test_mul2_i_pi_p_x(" << ni << ", " << np << ", " << sic << ", " << spa << ", "
     << spb << ")";
  ...
  try {
    ...
    linalg_generic::mul2_i_pi_p_x(0, ni, np, &a[0], spa, &b[0], spb, &c_ref[0], sic, d);
...
int main() {
  ...
  return
        ...
        test_mul2_i_pi_p_x(1, 1, 1, 1, 1) | test_mul2_i_pi_p_x(1, 2, 1, 1, 1) |
        test_mul2_i_pi_p_x(2, 1, 1, 2, 1) | test_mul2_i_pi_p_x(16, 16, 1, 16, 1) |
        test_mul2_i_pi_p_x(17, 3, 1, 17, 1) | test_mul2_i_pi_p_x(2, 2, 2, 3, 4) |
