...
void linalg_mul2_ij_pi_pj_x_test::perform() throw(libtest::test_exception) {
...
void linalg_mul2_ij_pi_pj_x_test::test_mul2_ij_pi_pj_x(size_t ni, size_t nj,
    size_t np, size_t sic, size_t spa, size_t spb) {

    std::ostringstream ss;
    ss << "linalg_mul2_ij_pi_pj_x_test::test_mul2_ij_pi_pj_x("
        << ni << ", " << nj << ", " << np << ", " << sic << ", "
        << spa << ", " << spb << ")";
    ...
    d = 0.0;
    linalg::mul2_ij_pi_pj_x(ni, nj, np, &a[0], spa, &b[0], spb, &c[0], sic, d);
    linalg_generic::mul2_ij_pi_pj_x(ni, nj, np, &a[0], spa, &b[0], spb,
        &c_ref[0], sic, d);
