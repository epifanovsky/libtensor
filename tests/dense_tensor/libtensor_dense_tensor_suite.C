...
libtensor_dense_tensor_suite::libtensor_dense_tensor_suite() :
    ...
    add_test("to_apply", m_utf_to_apply);
    ...
    add_test("to_ewmult2", m_utf_to_ewmult2);
    add_test("tod_extract", m_utf_tod_extract);
    add_test("to_extract", m_utf_to_extract);
    add_test("tod_import_raw", m_utf_tod_import_raw);
    add_test("to_import_raw", m_utf_to_import_raw);
    add_test("tod_import_raw_stream", m_utf_tod_import_raw_stream);
    add_test("to_import_raw_stream", m_utf_to_import_raw_stream);
    ...
    add_test("to_scale", m_utf_to_scale);
    add_test("tod_scatter", m_utf_tod_scatter);
    add_test("to_scatter", m_utf_to_scatter);
    add_test("tod_select", m_utf_tod_select);
    add_test("to_select", m_utf_to_select);
    ...
    add_test("to_set_diag", m_utf_to_set_diag);
    add_test("tod_set_elem", m_utf_tod_set_elem);
    add_test("to_set_elem", m_utf_to_set_elem);
    add_test("tod_size", m_utf_tod_size);
    add_test("to_size", m_utf_to_size);
    add_test("tod_trace", m_utf_tod_trace);
    add_test("to_trace", m_utf_to_trace);
    add_test("tod_vmpriority", m_utf_tod_vmpriority);
    add_test("to_vmpriority", m_utf_to_vmpriority);
}
