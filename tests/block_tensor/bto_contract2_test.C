...
void bto_contract2_test::perform() throw(libtest::test_exception) {
    std::cout << "Testing bto_contract2_test_x<double>  ";
    bto_contract2_test_x<double> t_double;
    t_double.perform();
    std::cout << "Testing bto_contract2_test_x<float>  ";
    bto_contract2_test_x<float> t_float;
    t_float.perform();
}


template<>
const double bto_contract2_test_x<double>::k_thresh = 7e-14;

template<>
const float bto_contract2_test_x<float>::k_thresh = 2e-5;

template<typename T>
void bto_contract2_test_x<T>::perform() throw(libtest::test_exception) {
...
template<typename T>
void bto_contract2_test_x<T>::test_bis_1() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_bis_1()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bisa);
        block_tensor<2, T, allocator_t> btb(bisb);
        contraction2<3, 1, 1> contr;
        contr.contract(3, 1);

        bto_contract2<3, 1, 1, T> op(contr, bta, btb);
...
template<typename T>
void bto_contract2_test_x<T>::test_bis_2() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_bis_2()";
...
template<typename T>
void bto_contract2_test_x<T>::test_bis_3() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_bis_3()";
...
template<typename T>
void bto_contract2_test_x<T>::test_bis_4() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_bis_4()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bisa), btb(bisb);
        contraction2<2, 2, 2> contr;
        contr.contract(0, 2);
        contr.contract(1, 3);

        bto_contract2<2, 2, 2, T> op(contr, bta, btb);
...
template<typename T>
void bto_contract2_test_x<T>::test_bis_5() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_bis_5()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bisa);
        block_tensor<5, T, allocator_t> btb(bisb);
        contraction2<1, 2, 3> contr;
        contr.contract(1, 1);
        contr.contract(2, 2);
        contr.contract(3, 3);

        bto_contract2<1, 2, 3, T> op(contr, bta, btb);
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_zeroblk_1() throw(libtest::test_exception) {

    static const char *testname = "bto_contract2_test_x<T>::test_zeroblk_1()";
    ...
    try {
        ...
        index<2> i_00;
        bto_random<2, T>().perform(btb, i_00);
        bta.set_immutable();
        btb.set_immutable();
        ...
        contr.contract(1, 1);
        bto_contract2<1, 1, 1, T>(contr, bta, btb).perform(btc);

        //  Check the zero block structure

        block_tensor_ctrl<2, T> btcc(btc);
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_zeroblk_2() throw(libtest::test_exception) {

    static const char *testname = "bto_contract2_test_x<T>::test_zeroblk_2()";
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_zeroblk_3() throw(libtest::test_exception) {

    static const char *testname = "bto_contract2_test_x<T>::test_zeroblk_3()";
    ...
    try {
        ...
        index<2> i_00;
        bto_random<2, T>().perform(bta, i_00);
        bta.set_immutable();
        btb.set_immutable();
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_zeroblk_4() throw(libtest::test_exception) {

    static const char *testname = "bto_contract2_test_x<T>::test_zeroblk_4()";
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_zeroblk_5() throw(libtest::test_exception) {

    static const char *testname = "bto_contract2_test_x<T>::test_zeroblk_5()";
    ...
    try {
        ...
        i_11[0] = 1; i_11[1] = 1;
        bto_random<2, T>().perform(bta, i_00);
        bto_random<2, T>().perform(bta, i_11);
        bto_random<2, T>().perform(btb, i_00);
        bto_random<2, T>().perform(btb, i_11);
        bta.set_immutable();
        btb.set_immutable();
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_zeroblk_6() throw(libtest::test_exception) {

    static const char *testname = "bto_contract2_test_x<T>::test_zeroblk_6()";
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_1() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_1()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bisa), btb(bisb), btc(bisc);
        ...
        dense_tensor<4, T, allocator_t> ta(dims), tb(dims), tc(dims),
                tc_ref(dims);
        to_btconv<4, T> conva(bta);
        conva.perform(ta);
        to_btconv<4, T> convb(btb);
        convb.perform(tb);
        to_btconv<4, T> convc(btc);
        convc.perform(tc);

        //  Compute reference tensor

        to_contract2<2, 2, 2, T> op_ref(contr, ta, tb);
        op_ref.perform(true, tc_ref);

        //  Compare against reference

        compare_ref_x<4, T>::compare(testname, tc, tc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_2() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_2()";
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_3() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_3()";
    ...
    try {
        ...
        dense_tensor<4, T, allocator_t> ta(dimsa), tb(dimsb), tc(dimsc),
                tc_ref(dimsc);
        to_btconv<4, T> conva(bta);
        conva.perform(ta);
        to_btconv<4, T> convb(btb);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_4() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_4()";
    ...
    try {
        ...
        se_perm<4, T> cycle1(p1023, tr0), cycle2(p0132, tr0);
        block_tensor_ctrl<4, T> ctrla(bta), ctrlb(btb);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_5() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_5()";
    ...
    try {
        ...
        scalar_transf<T> tr0, tr1(-1.);
        se_perm<4, T> cycle1(p1023, tr0), cycle2(p0132, tr0);
        block_tensor_ctrl<4, T> ctrla(bta), ctrlb(btb), ctrlc(btc);
        ctrla.req_symmetry().insert(cycle1);
        ctrla.req_symmetry().insert(cycle2);
        ctrlb.req_symmetry().insert(cycle1);
        ctrlb.req_symmetry().insert(cycle2);
        ...
        to_contract2<2, 2, 2, T> op_ref(contr, ta, tb, 2.0);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_6() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_6()";
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_7() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_7()";
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bisa);
        block_tensor<4, T, allocator_t> btb(bisb), btc(bisc);

        //  Load random data for input

        bto_random<2, T>().perform(bta);
        bto_random<4, T>().perform(btb);
        bta.set_immutable();
        btb.set_immutable();
        ...
        bto_contract2<1, 3, 1, T> op(contr, bta, btb);
        op.perform(btc);

        //  Convert block tensors to regular tensors

        dense_tensor<2, T, allocator_t> ta(dimsa);
        dense_tensor<4, T, allocator_t> tb(dimsb), tc(dimsc), tc_ref(dimsc);
        to_btconv<2, T> conva(bta);
        conva.perform(ta);
        to_btconv<4, T> convb(btb);
        convb.perform(tb);
        to_btconv<4, T> convc(btc);
        ...
        to_contract2<1, 3, 1, T> op_ref(contr, ta, tb);
        op_ref.perform(true, tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_8() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_8()";
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_9() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_9()";
    ...
    try {
        ...
        to_contract2<1, 3, 1, T> op_ref(contr, ta, tb, -1.0);
        op_ref.perform(false, tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_10() throw(libtest::test_exception) {

    //
    //  c_ijkl = - a_pi b_jklp
    //  Dimensions [ijkl]=10, [p]=6, no symmetry
    //  Copy with -1.0 vs. a coefficient in bto_contract2
    //

    static const char *testname = "bto_contract2_test_x<T>::test_contr_10()";
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bisa);
        block_tensor<4, T, allocator_t> btb(bisb);
        block_tensor<4, T, allocator_t> btc(bisc), btc_ref(bisc),
                btc_ref_tmp(bisc);
        ...
        bto_contract2<1, 3, 1, T>(contr, bta, btb).perform(btc, -1.0);
        bto_contract2<1, 3, 1, T>(contr, bta, btb).perform(btc_ref_tmp);
        bto_copy<4, T>(btc_ref_tmp, -1.0).perform(btc_ref);

        //  Compare against reference

        compare_ref_x<4, T>::compare(testname, btc, btc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_11() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_11()";
    ...
    try {
        ...
        bto_contract2<2, 2, 0, T>(contr, bta, btb).perform(btc);
        to_btconv<4, T>(btc).perform(tc);
        to_contract2<2, 2, 0, T>(contr, ta, tb).perform(true, tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_12() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_12()";
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_13() throw(libtest::test_exception) {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_13()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bisa);
        block_tensor<2, T, allocator_t> btb(bisb);
        block_tensor<2, T, allocator_t> btc(bisc), btc_ref(bisc),
                btc_ref_tmp(bisc);

        //  Load random data for input

        bto_random<4, T>().perform(bta);
        bto_random<2, T>().perform(btb);
        bta.set_immutable();
        btb.set_immutable();
        ...
        dense_tensor<4, T, allocator_t> ta(dimsa);
        dense_tensor<2, T, allocator_t> tb(dimsb);
        dense_tensor<2, T, allocator_t> tc(dimsc), tc_ref(dimsc);
        to_btconv<4, T>(bta).perform(ta);
        to_btconv<2, T>(btb).perform(tb);
        ...
        bto_contract2<2, 0, 2, T> op(contr, bta, btb);
        op.perform(btc);
        to_btconv<2, T>(btc).perform(tc);
        to_contract2<2, 0, 2, T>(contr, ta, tb).perform(true, tc_ref);

        //  Compare against reference

        compare_ref_x<2, T>::compare(testname, tc, tc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_14(T c)
throw(libtest::test_exception) {
    ...
    ss << "bto_contract2_test_x<T>::test_contr_14(" << c << ")";
    ...
    try {
        ...
        dense_tensor<4, T, allocator_t> tb(dims);
        dense_tensor<4, T, allocator_t> tc(dims), tc_ref(dims);
        to_btconv<4, T>(bta).perform(ta);
        to_btconv<4, T>(btb).perform(tb);
        if(c != 0.0) to_btconv<4, T>(btc).perform(tc_ref);
        ...
        if(c == 0.0) bto_contract2<2, 2, 2, T>(contr, bta, btb).perform(btc);
        else bto_contract2<2, 2, 2, T>(contr, bta, btb).perform(btc, c);
        to_btconv<4, T>(btc).perform(tc);
        if(c == 0.0) {
            to_contract2<2, 2, 2, T>(contr, ta, tb).perform(true, tc_ref);
        } else {
            to_contract2<2, 2, 2, T>(contr, ta, tb, c).perform(false, tc_ref);
        }

        //  Compare against reference

        compare_ref_x<4, T>::compare(tn.c_str(), tc, tc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_15(T c)
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_15(" << c << ")";
    std::string tn = ss.str();
    ...
    try {
        ...
        for(size_t i = 0; i < 3; i++) {
            ...
            bto_random<4, T>().perform(bta, blkidx);
            bto_random<4, T>().perform(btb, blkidx);
            bto_random<4, T>().perform(btc, blkidx);
        }
        bta.set_immutable();
        btb.set_immutable();
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_16(T c)
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_16(" << c << ")";
    std::string tn = ss.str();
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bis_iaaa);
        block_tensor<4, T, allocator_t> btb(bis_iiaa);
        block_tensor<4, T, allocator_t> btc(bis_iaaa);
        ...
        dense_tensor<4, T, allocator_t> ta(dims_iaaa);
        dense_tensor<4, T, allocator_t> tb(dims_iiaa);
        dense_tensor<4, T, allocator_t> tc(dims_iaaa), tc_ref(dims_iaaa);
        to_btconv<4, T>(bta).perform(ta);
        to_btconv<4, T>(btb).perform(tb);
        to_set<4, T>().perform(true, tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_17(T c)
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_17(" << c << ")";
    std::string tn = ss.str();
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bis_iiaa);
        block_tensor<4, T, allocator_t> btb(bis_iiaa);
        block_tensor<2, T, allocator_t> btc(bis_ii);

        //  Install symmetry
        {
            scalar_transf<T> tr0;
            block_tensor_ctrl<4, T> ca(bta);
            ca.req_symmetry().insert(se_perm<4, T>(permutation<4>().
                    permute(0, 1), tr0));
            ca.req_symmetry().insert(se_perm<4, T>(permutation<4>().
                    permute(2, 3), tr0));
        }
        ...
        bto_random<4, T>().perform(bta);
        bto_random<4, T>().perform(btb);
        if(c != 0.0) bto_random<2, T>().perform(btc);
        bta.set_immutable();
        btb.set_immutable();

        //  Convert block tensors to regular tensors

        dense_tensor<4, T, allocator_t> ta(dims_iiaa);
        dense_tensor<4, T, allocator_t> tb(dims_iiaa);
        dense_tensor<2, T, allocator_t> tc(dims_ii), tc_ref(dims_ii);
        to_btconv<4, T>(bta).perform(ta);
        to_btconv<4, T>(btb).perform(tb);
        ...
        if(c == 0.0) bto_contract2<1, 1, 3, T>(contr, bta, btb).perform(btc);
        else bto_contract2<1, 1, 3, T>(contr, bta, btb).perform(btc, c);
        to_btconv<2, T>(btc).perform(tc);
        if(c == 0.0) {
            to_contract2<1, 1, 3, T>(contr, ta, tb).perform(true, tc_ref);
        } else {
            to_contract2<1, 1, 3, T>(contr, ta, tb, c).perform(false, tc_ref);
        }

        //  Compare against reference

        compare_ref_x<2, T>::compare(tn.c_str(), tc, tc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_18(T c)
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_18(" << c << ")";
    std::string tn = ss.str();
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bis_iiaa);
        block_tensor<4, T, allocator_t> btb(bis_iaia);
        block_tensor<2, T, allocator_t> btc(bis_ii);
        ...
        dense_tensor<4, T, allocator_t> ta(dims_iiaa);
        dense_tensor<4, T, allocator_t> tb(dims_iaia);
        dense_tensor<2, T, allocator_t> tc(dims_ii), tc_ref(dims_ii);
        to_btconv<4, T>(bta).perform(ta);
        to_btconv<4, T>(btb).perform(tb);
        to_btconv<2, T>(btc).perform(tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_19()
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_19()";
    std::string tn = ss.str();
    ...
    block_tensor<4, T, allocator_t> bta(bis_iiii);
    block_tensor<4, T, allocator_t> btb(bis_iiaa);
    block_tensor<4, T, allocator_t> btc(bis_iiaa);
    symmetry<4, T> symc_ref(bis_iiaa);

    { // set symmetry
    scalar_transf<T> tr0, tr1(-1.);
    se_perm<4, T> sp1023(permutation<4>().permute(0, 1), tr1);
    se_perm<4, T> sp0132(permutation<4>().permute(2, 3), tr1);
    se_perm<4, T> sp2301(
            permutation<4>().permute(0, 2).permute(1, 3), tr0);

    se_label<4, T> sla(bis_iiii.get_block_index_dims(), ss.str());
    block_labeling<4> &bla = sla.get_labeling();
    bla.assign(m1, 0, 0);
    bla.assign(m1, 1, 1);
    bla.assign(m1, 2, 1);
    sla.set_rule(0);
    se_label<4, T> slb(bis_iiaa.get_block_index_dims(), ss.str());
    ...
    block_tensor_ctrl<4, T> ca(bta), cb(btb);
    ...
    dense_tensor<4, T, allocator_t> ta(dims_iiii);
    dense_tensor<4, T, allocator_t> tb(dims_iiaa);
    dense_tensor<4, T, allocator_t> tc(dims_iiaa), tc_ref(dims_iiaa);
    to_btconv<4, T>(bta).perform(ta);
    to_btconv<4, T>(btb).perform(tb);
    to_btconv<4, T>(btc).perform(tc_ref);
    ...
    contr.contract(2, 0);
    contr.contract(3, 1);
    bto_contract2<2, 2, 2, T>(contr, bta, btb).perform(btc);
    to_btconv<4, T>(btc).perform(tc);
    to_contract2<2, 2, 2, T>(contr, ta, tb).perform(true, tc_ref);
    ...
    compare_ref_x<4, T>::compare(tn.c_str(), cc.req_const_symmetry(), symc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_20a()
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_20a()";
    std::string tn = ss.str();
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bisa);
        block_tensor<2, T, allocator_t> btb(bisb);
        block_tensor<2, T, allocator_t> btc(bisa);

        { // set symmetry
            scalar_transf<T> tr0;
            se_perm<2, T> sp10(permutation<2>().permute(0, 1), tr0);
            se_part<2, T> spa(bisa, m10, 2);
            index<2> i00, i10; i10[0] = 1;
            spa.add_map(i00, i10, tr0);

            block_tensor_ctrl<2, T> ca(bta), cb(btb);
        ...
        dense_tensor<2, T, allocator_t> ta(bisa.get_dims());
        dense_tensor<2, T, allocator_t> tb(bisb.get_dims());
        dense_tensor<2, T, allocator_t> tc(bisa.get_dims()), tc_ref(bisa.get_dims());
        to_btconv<2, T>(bta).perform(ta);
        to_btconv<2, T>(btb).perform(tb);
        ...
        bto_contract2<1, 1, 1, T>(contr, bta, btb).perform(btc);
        to_btconv<2, T>(btc).perform(tc);
        to_contract2<1, 1, 1, T>(contr, ta, tb).perform(true, tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_20b()
throw(libtest::test_exception) {
    ...
    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_20b()";
    std::string tn = ss.str();
    ...
    try {
        ...
        symmetry<2, T> sym_ref(bisa);

        { // Set symmetry
            scalar_transf<T> tr0;
            se_perm<2, T> sp10(permutation<2>().permute(0, 1), tr0);
            se_part<2, T> spa(bisa, m11, 2), spb(bisb, m11, 2);
        ...
        //  Compare against reference
        {
            block_tensor_ctrl<2, T> cc(btc);
            compare_ref_x<2, T>::compare(tn.c_str(), cc.req_const_symmetry(), sym_ref);
        }
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_contr_21() throw(libtest::test_exception) {

    std::ostringstream ss;
    ss << "bto_contract2_test_x<T>::test_contr_21()";
    std::string tn = ss.str();
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bisa);
        block_tensor<2, T, allocator_t> btb(bisa);
        block_tensor<2, T, allocator_t> btc(bisc);

        { // set symmetry
            scalar_transf<T> tr0;
            se_part<2, T> spa(bisa, m11, 2);
            spa.add_map(i00, i11, tr0);
            spa.mark_forbidden(i01);
            spa.mark_forbidden(i10);
        ...
        dense_tensor<2, T, allocator_t> ta(bisa.get_dims());
        dense_tensor<2, T, allocator_t> tb(bisa.get_dims());
        dense_tensor<2, T, allocator_t> tc(bisc.get_dims()),
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_22() {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_contr_22()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> btb(bisb), btc(bisc), bti(bisi);

        //  Set symmetry

        se_perm<3, T> seperma1(permutation<3>().permute(0, 1),
            scalar_transf<T>(1.0));
        se_perm<4, T> sepermb1(permutation<4>().permute(0, 1),
            scalar_transf<T>(-1.0));
        se_perm<4, T> sepermb2(permutation<4>().permute(2, 3),
            scalar_transf<T>(-1.0));
        se_perm<4, T> sepermi1(permutation<4>().permute(0, 2),
            scalar_transf<T>(1.0));
        se_perm<4, T> sepermi2(permutation<4>().permute(1, 3),
            scalar_transf<T>(1.0));
        se_perm<4, T> sepermi3(permutation<4>().permute(0, 1).
            permute(2, 3), scalar_transf<T>(1.0));
        symmetry<4, T> symi_ref(bisi);

        {
            block_tensor_ctrl<3, T> ca(bta);
            ca.req_symmetry().insert(seperma1);

            block_tensor_ctrl<4, T> cb(btb);
        ...
        bto_contract2<2, 2, 1, T>(contr1, bta, bta).perform(bti);
        {
        block_tensor_ctrl<4, T> ctrli(bti);
        compare_ref_x<4, T>::compare(testname, ctrli.req_const_symmetry(), symi_ref);
        }
        bto_contract2<2, 2, 2, T>(contr2, bti, btb).perform(btc);

        //  Convert block tensors to regular tensors

        dense_tensor<3, T, allocator_t> ta(dimsa);
        dense_tensor<4, T, allocator_t> tb(dimsb), ti(dimsi),
            ti_ref(dimsi), tc(dimsc), tc_ref(dimsc);
        to_btconv<3, T>(bta).perform(ta);
        to_btconv<4, T>(btb).perform(tb);
        to_btconv<4, T>(btc).perform(tc);
        to_btconv<4, T>(bti).perform(ti);

        //  Compute reference tensor

        to_contract2<2, 2, 1, T>(contr1, ta, ta).perform(true, ti_ref);
        to_contract2<2, 2, 2, T>(contr2, ti_ref, tb).perform(true, tc_ref);

        //  Compare against reference

        compare_ref_x<4, T>::compare(testname, ti, ti_ref, k_thresh);
        compare_ref_x<4, T>::compare(testname, tc, tc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_23() {

    const char *testname = "bto_contract2_test_x<T>::test_contr_23()";
    ...
    block_tensor<4, T, allocator_t> bt1(bis_kija), bt2(bis_ijab),
        bt3(bis_ijka);
    ...
    contr.contract(1, 1);
    contr.contract(3, 3);
    bto_contract2<2, 2, 2, T>(contr, bt1, bt2).perform(bt3);

    dense_tensor<4, T, allocator_t> t1(dims_kija), t2(dims_ijab),
        t3(dims_ijka), t3_ref(dims_ijka);
    to_btconv<4, T>(bt1).perform(t1);
    to_btconv<4, T>(bt2).perform(t2);
    to_btconv<4, T>(bt3).perform(t3);
    to_contract2<2, 2, 2, T>(contr, t1, t2).perform(true, t3_ref);

    compare_ref_x<4, T>::compare(testname, t3, t3_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_24() {

    const char *testname = "bto_contract2_test_x<T>::test_contr_24()";
    ...
    se_label<3, T> se1(bidimsa, "d2h");
    se_label<3, T> se2(bidimsb, "d2h");
    se_label<4, T> se3(bidimsc, "d2h");
    ...
    se_part<3, T> se4(bisa, m110, 2);
    se_part<3, T> se5(bisb, m110, 2);
    index<3> i000, i010, i100, i110;
    i100[0] = 1; i010[1] = 1;
    i110[0] = 1; i110[1] = 1;
    se4.add_map(i000, i110, scalar_transf<T>(1.0));
    se4.add_map(i010, i100, scalar_transf<T>(1.0));
    se4.mark_forbidden(i010);
    se5.add_map(i000, i110, scalar_transf<T>(1.0));
    se5.add_map(i010, i100, scalar_transf<T>(1.0));
    se5.mark_forbidden(i010);

    symmetry<3, T> syma(bisa), symb(bisb);
    symmetry<4, T> symc(bisc);
    syma.insert(se1);
    syma.insert(se4);
    symb.insert(se2);
    symb.insert(se5);
    ...
    block_tensor<3, T, allocator_t> bta(bisa), btb(bisb);
    block_tensor<4, T, allocator_t> btc(bisc);

    {
        block_tensor_wr_ctrl<3, T> ca(bta), cb(btb);
        so_copy<3, T>(syma).perform(ca.req_symmetry());
        so_copy<3, T>(symb).perform(cb.req_symmetry());
    }
    ...
    contr.contract(2, 2);
    bto_contract2<2, 2, 1, T>(contr, bta, btb).perform(btc);

    dense_tensor<3, T, allocator_t> ta(dimsa), tb(dimsb);
    dense_tensor<4, T, allocator_t> tc(dimsc), tc_ref(dimsc);
    to_btconv<3, T>(bta).perform(ta);
    to_btconv<3, T>(btb).perform(tb);
    to_btconv<4, T>(btc).perform(tc);
    to_contract2<2, 2, 1, T>(contr, ta, tb).perform(true, tc_ref);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_25() {

    const char *testname = "bto_contract2_test_x<T>::test_contr_25()";
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_26() {

    const char *testname = "bto_contract2_test_x<T>::test_contr_26()";
    ...
    se_label<2, T> se1(bidimsa, "d2h");
    se_label<2, T> se2(bidimsb, "d2h");
    se_label<4, T> se3(bidimsc, "d2h");
    ...
    se_part<2, T> se4(bisa, m11, 2);
    se_part<2, T> se5(bisb, m11, 2);
    index<2> i00, i01, i10, i11;
    i10[0] = 1; i01[1] = 1;
    i11[0] = 1; i11[1] = 1;
    se4.add_map(i00, i11, scalar_transf<T>(1.0));
    se4.add_map(i01, i10, scalar_transf<T>(1.0));
    se4.mark_forbidden(i01);
    se5.add_map(i00, i11, scalar_transf<T>(1.0));
    se5.add_map(i01, i10, scalar_transf<T>(1.0));
    se5.mark_forbidden(i01);

    symmetry<2, T> syma(bisa), symb(bisb);
    symmetry<4, T> symc(bisc);
    syma.insert(se1);
    syma.insert(se4);
    symb.insert(se2);
    ...
    block_tensor<2, T, allocator_t> bta(bisa), btb(bisb);
    block_tensor<4, T, allocator_t> btc(bisc);

    {
        block_tensor_wr_ctrl<2, T> ca(bta), cb(btb);
        so_copy<2, T>(syma).perform(ca.req_symmetry());
        so_copy<2, T>(symb).perform(cb.req_symmetry());
    }
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_27() {

    const char testname[] = "bto_contract2_test_x<T>::test_contr_27()";
    ...
    {
        block_tensor_wr_ctrl<2, T> ca(bta), cb(btb);
        symmetry<2, T> &sa = ca.req_symmetry(), &sb = cb.req_symmetry();

        sa.insert(se_perm<2, T>(permutation<2>().permute(0, 1),
                scalar_transf<T>(1.0)));

        se_part<2, T> pa(bisa, ma, 2);
        se_part<2, T> pb(bisb, mb, 2);
        index<2> i00, i01, i10, i11;
        i10[0] = 1; i01[1] = 1;
        i11[0] = 1; i11[1] = 1;
        pa.add_map(i00, i11, scalar_transf<T>(1.0));
        pa.add_map(i01, i10, scalar_transf<T>(1.0));
        pa.mark_forbidden(i01);
        pb.add_map(i00, i10, scalar_transf<T>(1.0));
        sa.insert(pa);
        sb.insert(pb);
        ...
        se_label<2, T> la(bidimsa, "c2v");
        se_label<2, T> lb(bidimsb, "c2v");
    ...
    c1.contract(1, 0);
    c2.contract(0, 0);
    bto_contract2<1, 1, 1, T>(c1, bta, btb).perform(btt);
    bto_contract2<1, 1, 1, T>(c2, btb, btt).perform(btc);
    ...
    to_btconv<2, T>(bta).perform(ta);
    to_btconv<2, T>(btb).perform(tb);
    to_btconv<2, T>(btt).perform(tt);
    to_btconv<2, T>(btc).perform(tc);

    to_contract2<1, 1, 1, T>(c1, ta, tb).perform(true, tt_ref);
    to_contract2<1, 1, 1, T>(c2, tb, tt_ref).perform(true, tc_ref);

    std::ostringstream ss_tb;
    ss_tb << testname << " [tt]";
    compare_ref_x<2, T>::compare(ss_tb.str().c_str(), tt, tt_ref, k_thresh);
    compare_ref_x<2, T>::compare(testname, tc, tc_ref, k_thresh);
...
template<typename T>
void bto_contract2_test_x<T>::test_contr_28() {

    const char testname[] = "bto_contract2_test_x<T>::test_contr_28()";
    ...
    block_tensor<4, T, allocator_t> bta(bisa);
    block_tensor<3, T, allocator_t> btb(bisb), btc(bisc);

    {
        block_tensor_wr_ctrl<4, T> ca(bta);
        symmetry<4, T> &syma = ca.req_symmetry();

        syma.insert(se_perm<4, T>(
            permutation<4>().permute(0, 2).permute(1, 3),
            scalar_transf<T>(1.0)));
        se_label<4, T> la(bisa.get_block_index_dims(), "c2v");
    ...
    {
        block_tensor_wr_ctrl<3, T> cb(btb);
        symmetry<3, T> &symb = cb.req_symmetry();

        se_label<3, T> lb(bisb.get_block_index_dims(), "c2v");
    ...
    bto_contract2<2, 1, 2, T>(contr1, bta, btb).perform(btc);
    //bto_contract2<1, 2, 2>(contr2, btb, bta).perform(btc);

    dense_tensor<4, T, allocator_t> ta(dimsa);
    dense_tensor<3, T, allocator_t> tb(dimsb), tc(dimsc), tc_ref(dimsc);

    to_btconv<4, T>(bta).perform(ta);
    to_btconv<3, T>(btb).perform(tb);
    to_btconv<3, T>(btc).perform(tc);

    to_contract2<2, 1, 2, T>(contr1, ta, tb).perform(true, tc_ref);

    compare_ref_x<3, T>::compare(testname, tc, tc_ref, k_thresh);
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_self_1() {

    static const char *testname = "bto_contract2_test_x<T>::test_self_1()";
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bis_ia);
        block_tensor<4, T, allocator_t> btc(bis_ijab);
        ...
        bto_contract2<2, 2, 0, T>(contr, bta, bta).perform(btc);

        //  Convert block tensors to regular tensors

        dense_tensor<2, T, allocator_t> ta(dims_ia);
        dense_tensor<4, T, allocator_t> tc(dims_ijab), tc_ref(dims_ijab);
        to_btconv<2, T>(bta).perform(ta);
        to_btconv<4, T>(btc).perform(tc);

        //  Compute reference symmetry and tensor

        symmetry<4, T> symc(bis_ijab), symc_ref(bis_ijab);
        scalar_transf<T> tr0;
       symc_ref.insert(se_perm<4, T>(permutation<4>().
                permute(0, 1).permute(2, 3), tr0));
        {
            block_tensor_ctrl<4, T> cc(btc);
            so_copy<4, T>(cc.req_const_symmetry()).perform(symc);
        }
        to_contract2<2, 2, 0, T>(contr, ta, ta).perform(true, tc_ref);

        //  Compare against reference

        compare_ref_x<4, T>::compare(testname, symc, symc_ref);
        compare_ref_x<4, T>::compare(testname, tc, tc_ref, k_thresh);
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_self_2() {

    static const char *testname = "bto_contract2_test_x<T>::test_self_2()";
    ...
    try {
        ...
        block_tensor<3, T, allocator_t> bta(bis_iac);
        block_tensor<4, T, allocator_t> btc(bis_ijab);
        ...
        contraction2<2, 2, 1> contr(permutation<4>().permute(1, 2));
        contr.contract(2, 2);
        bto_contract2<2, 2, 1, T>(contr, bta, bta).perform(btc);

        //  Convert block tensors to regular tensors

        dense_tensor<3, T, allocator_t> ta(dims_iac);
        dense_tensor<4, T, allocator_t> tc(dims_ijab), tc_ref(dims_ijab);
        to_btconv<3, T>(bta).perform(ta);
        to_btconv<4, T>(btc).perform(tc);
        ...
        to_contract2<2, 2, 1, T>(contr, ta, ta).perform(true, tc_ref);
 ...
 **/
template<typename T>
void bto_contract2_test_x<T>::test_self_3() {

    static const char *testname = "bto_contract2_test_x<T>::test_self_3()";
    ...
    try {
...

        {
            block_tensor_ctrl<3, T> ca(bta);
            scalar_transf<T> tr0;
            ca.req_symmetry().insert(se_perm<3, T>(
...
template<typename T>
void bto_contract2_test_x<T>::test_batch_1() {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_batch_1()";
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bis2), btb(bis2);
        block_tensor<4, T, allocator_t> btc(bis4);
        ...
        dense_tensor<2, T, allocator_t> ta(dims2), tb(dims2);
        dense_tensor<4, T, allocator_t> tc(dims4), tc_ref(dims4);
        to_btconv<2, T>(bta).perform(ta);
        to_btconv<2, T>(btb).perform(tb);
        to_btconv<4, T>(btc).perform(tc);
...
template<typename T>
void bto_contract2_test_x<T>::test_batch_2() {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_batch_2()";
    ...
    try {
        ...
        block_tensor<4, T, allocator_t> bta(bis4);
        block_tensor<2, T, allocator_t> btb(bis2);
        block_tensor<2, T, allocator_t> btc(bis2);
        ...
        bto_contract2<2, 0, 2, T>(contr, bta, btb).perform(btc);

        //  Convert block tensors to regular tensors

        dense_tensor<4, T, allocator_t> ta(dims4);
        dense_tensor<2, T, allocator_t> tb(dims2);
        dense_tensor<2, T, allocator_t> tc(dims2), tc_ref(dims2);
        to_btconv<4, T>(bta).perform(ta);
        to_btconv<2, T>(btb).perform(tb);
        to_btconv<2, T>(btc).perform(tc);
...
template<typename T>
void bto_contract2_test_x<T>::test_batch_3() {
    ...
    static const char *testname = "bto_contract2_test_x<T>::test_batch_3()";
    ...
    try {
        ...
        block_tensor<2, T, allocator_t> bta(bis2);
        block_tensor<4, T, allocator_t> btb(bis4);
        block_tensor<2, T, allocator_t> btc(bis2);
        ...
        bto_contract2<0, 2, 2, T>(contr, bta, btb).perform(btc);

        //  Convert block tensors to regular tensors

        dense_tensor<2, T, allocator_t> ta(dims2);
        dense_tensor<4, T, allocator_t> tb(dims4);
        dense_tensor<2, T, allocator_t> tc(dims2), tc_ref(dims2);
        to_btconv<2, T>(bta).perform(ta);
        to_btconv<4, T>(btb).perform(tb);
        to_btconv<2, T>(btc).perform(tc);
        ...
        to_contract2<0, 2, 2, T>(contr, ta, tb).perform(true, tc_ref);
