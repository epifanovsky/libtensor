...
void linalg_cublas_mul2_i_ip_p_x_test::perform()
...
void linalg_cublas_mul2_i_ip_p_x_test::test_mul2_i_ip_p_x(size_t ni, size_t np,
    size_t sia, size_t sic, size_t spb) {

    std::ostringstream ss;
    ss << "linalg_cublas_mul2_i_ip_p_test::test_mul2_i_ip_p_x("
        << ni << ", " << np << ", " << sia << ", " << sic << ", "
        << spb << ")";
    ...
    linalg_cublas::mul2_i_ip_p_x(cbh, ni, np, padl, sia, pbdl, spb, pcdl, sic,
        d);
