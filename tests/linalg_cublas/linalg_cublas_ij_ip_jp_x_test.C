...
void linalg_cublas_ij_ip_jp_x_test::perform() throw(libtest::test_exception) {
...
void linalg_cublas_ij_ip_jp_x_test::test_ij_ip_jp_x(size_t ni, size_t nj, size_t np, size_t sia,
        size_t sic, size_t sjb) {

	std::ostringstream ss;
	ss << "linalg_cublas_ij_ip_jp_x_test::test_ij_ip_jp_x("
		<< ni << ", " << nj << ", " << np << ", " << sia << ", "
		<< sic << ", " << sjb << ")";
    ...
    linalg_cublas::ij_ip_jp_x(cbh, ni, nj, np, padl, sia, pbdl, sjb, pcdl, sic,
    		d);
    linalg_base_generic::ij_ip_jp_x(ni, nj, np, pa, sia, pb, sjb, pc_ref, sic, d);
