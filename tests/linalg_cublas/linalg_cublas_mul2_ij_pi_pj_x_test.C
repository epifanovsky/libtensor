...
void linalg_cublas_mul2_ij_pi_pj_x_test::perform()
...
void linalg_cublas_mul2_ij_pi_pj_x_test::test_mul2_ij_pi_pj_x(size_t ni,
    size_t nj, size_t np, size_t sic, size_t spa, size_t spb) {

    std::ostringstream ss;
    ss << "linalg_cublas_mul2_ij_pi_pj_x_test::test_mul2_ij_pi_pj_x("
        << ni << ", " << nj << ", " << np << ", " << spa << ", "
        << sic << ", " << spb << ")";
    ...
    linalg_cublas::mul2_ij_pi_pj_x(cbh, ni, nj, np, padl, spa, pbdl, spb, pcdl,
        sic, d);
