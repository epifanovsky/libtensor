...
void linalg_cublas_copy_ij_ij_x_test::perform() throw(libtest::test_exception) {

    test_copy_ij_ij_x(1, 1, 1, 1);
    test_copy_ij_ij_x(1, 2, 2, 2);
    test_copy_ij_ij_x(2, 1, 1, 1);
    test_copy_ij_ij_x(16, 16, 16, 16);
    test_copy_ij_ij_x(3, 17, 17, 17);
    test_copy_ij_ij_x(2, 2, 3, 3);
    test_copy_ij_ij_x(2, 2, 4, 3);
}


void linalg_cublas_copy_ij_ij_x_test::test_copy_ij_ij_x(size_t ni, size_t nj,
    size_t sia, size_t sic) {

    std::ostringstream ss;
    ss << "linalg_cublas_copy_ij_ij_x_test::test_copy_ij_ij_x("
        << ni << ", " << nj << ", " << sia << ", " << sic << ")";
    ...
    linalg_cublas::copy_ij_ij_x(cbh, ni, nj, a1, sia, b, c1, sic);
    linalg_generic::copy_ij_ij_x(0, ni, nj, a, sia, b, c_ref, sic);
