...
void linalg_cublas_ij_ji_x_test::perform() throw(libtest::test_exception) {

	    test_ij_ji_x(1, 1, 1, 1);
	    test_ij_ji_x(1, 2, 1, 2);
	    test_ij_ji_x(2, 1, 2, 1);
	    test_ij_ji_x(16, 16, 16, 16);
	    test_ij_ji_x(3, 17, 5, 17);
	    test_ij_ji_x(2, 2, 2, 3);
	    test_ij_ji_x(2, 2, 4, 3);
}


void linalg_cublas_ij_ji_x_test::test_ij_ji_x(size_t ni, size_t nj, size_t sja, size_t sic) {
...
//    double *a = 0, *c = 0, *c_ref = 0;
    ...
    linalg_cublas::ij_ji_x(cbh, ni, nj, a1, sja, b, c1, sic);
    linalg_base_generic::ij_ji_x(ni, nj, a, sja, b, c_ref, sic);
