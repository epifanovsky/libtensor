...
void linalg_cublas_ij_pi_jp_x_test::perform() throw(libtest::test_exception) {
...
void linalg_cublas_ij_pi_jp_x_test::test_ij_pi_jp_x(size_t ni, size_t nj, size_t np, size_t sic,
	    size_t sjb, size_t spa) {

	std::ostringstream ss;
	ss << "linalg_cublas_ij_pi_jp_x_test::test_ij_pi_jp_x("
		<< ni << ", " << nj << ", " << np << ", " << spa << ", "
		<< sic << ", " << sjb << ")";
    ...
    linalg_cublas::ij_pi_jp_x(cbh, ni, nj, np, padl, spa, pbdl, sjb, pcdl, sic,
    		d);
    linalg_base_generic::ij_pi_jp_x(ni, nj, np, pa, spa, pb, sjb, pc_ref, sic, d);
