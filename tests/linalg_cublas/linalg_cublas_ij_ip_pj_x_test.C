...
void linalg_cublas_ij_ip_pj_x_test::perform() throw(libtest::test_exception) {
...
void linalg_cublas_ij_ip_pj_x_test::test_ij_ip_pj_x(size_t ni, size_t nj, size_t np, size_t sia,
        size_t sic, size_t spb) {

	std::ostringstream ss;
	ss << "linalg_cublas_ij_ip_pj_x_test::test_ij_ip_pj_x("
		<< ni << ", " << nj << ", " << np << ", " << sia << ", "
		<< sic << ", " << spb << ")";
