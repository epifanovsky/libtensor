...
void linalg_cublas_mul2_ij_pi_jp_x_test::perform()
...
void linalg_cublas_mul2_ij_pi_jp_x_test::test_mul2_ij_pi_jp_x(size_t ni,
    size_t nj, size_t np, size_t sic, size_t sjb, size_t spa) {

    std::ostringstream ss;
    ss << "linalg_cublas_mul2_ij_pi_jp_x_test::test_mul2_ij_pi_jp_x("
        << ni << ", " << nj << ", " << np << ", " << spa << ", "
        << sic << ", " << sjb << ")";
    ...
    linalg_cublas::mul2_ij_pi_jp_x(cbh, ni, nj, np, padl, spa, pbdl, sjb, pcdl,
        sic, d);
    linalg_generic::mul2_ij_pi_jp_x(0, ni, nj, np, pa, spa, pb, sjb, pc_ref,
        sic, d);
