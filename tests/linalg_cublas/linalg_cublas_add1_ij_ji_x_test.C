...
void linalg_cublas_add1_ij_ji_x_test::perform() throw(libtest::test_exception) {

    test_add1_ij_ji_x(1, 1, 1, 1);
    test_add1_ij_ji_x(1, 2, 1, 2);
    test_add1_ij_ji_x(2, 1, 2, 1);
    test_add1_ij_ji_x(16, 16, 16, 16);
    test_add1_ij_ji_x(3, 17, 5, 17);
    test_add1_ij_ji_x(2, 2, 2, 3);
    test_add1_ij_ji_x(2, 2, 4, 3);
}


void linalg_cublas_add1_ij_ji_x_test::test_add1_ij_ji_x(size_t ni, size_t nj,
    size_t sja, size_t sic) {

    std::ostringstream ss;
    ss << "linalg_cublas_add1_ij_ji_x_test::test_add1_ij_ji_x("
        << ni << ", " << nj << ", " << sja << ", " << sic << ")";
    ...
    linalg_cublas::add1_ij_ji_x(cbh, ni, nj, a1, sja, b, c1, sic);
    linalg_generic::add1_ij_ji_x(0, ni, nj, a, sja, b, c_ref, sic);
