...
void linalg_cublas_i_ip_p_x_test::test_i_ip_p_x(size_t ni, size_t np, size_t sia,
    ...
    linalg_cublas::i_ip_p_x(cbh, ni, np, padl, sia, pbdl, spb, pcdl, sic, d);
    linalg_generic::mul2_i_ip_p_x(0, ni, np, a, sia, b, spb, c_ref, sic, d);
