...
void so_projdown_test::perform() throw(libtest::test_exception) {
...
void so_projdown_test::test_1() throw(libtest::test_exception) {

	static const char *testname = "so_projdown_test::test_1()";
...
void so_projdown_test::test_2() throw(libtest::test_exception) {

	static const char *testname = "so_projdown_test::test_2()";
