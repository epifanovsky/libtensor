#include <libtensor/btensor/bispace.h>
...
void bispace_test::test_1() throw (libtest::test_exception) {
    ...
    if(!a.get_bis().equals(bisa_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for a.");
    }
    ...
    if(!b.get_bis().equals(bisb_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for b.");
    }
    ...
    if(!ca.get_bis().equals(bisa_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for ca.");
    }
    ...
    if(!cb.get_bis().equals(bisb_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for cb.");
    }
    ...
    if(!a.equals(ca)) {
        fail_test(testname, __FILE__, __LINE__, "Equality test failed for ca.");
    }
    if(!b.equals(cb)) {
        fail_test(testname, __FILE__, __LINE__, "Equality test failed for cb.");
    }
...
void bispace_test::test_2() throw (libtest::test_exception) {
    ...
    if(!aa.get_bis().equals(bisa_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for aa.");
    }
    ...
    if(!bb.get_bis().equals(bisb_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for bb.");
    }
    ...
    if(!caa.get_bis().equals(bisa_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for caa.");
    }
    ...
    if(!cbb.get_bis().equals(bisb_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for cbb.");
    }
...
void bispace_test::test_4() throw (libtest::test_exception) {
    ...
    if(!aaaa.get_bis().equals(bisa_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for aaaa.");
    }
    ...
    if(!bbbb.get_bis().equals(bisb_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for bbbb.");
    }
...
void bispace_test::test_5() throw (libtest::test_exception) {
    ...
    if(!ijab2.get_bis().equals(bis2_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for ijab2.");
    }
...
void bispace_test::test_8() throw (libtest::test_exception) {
    ...
    if(!abicd2.get_bis().equals(bis2_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for abicd2.");
    }
    ...
    if(!cabicd2.get_bis().equals(bis2_ref)) {
        fail_test(testname, __FILE__, __LINE__, "Bis test failed for cabicd2.");
    }
