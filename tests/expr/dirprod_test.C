...
void dirprod_test::perform() throw(libtest::test_exception) {
...
void dirprod_test::test_tt_1() throw(libtest::test_exception) {

    static const char *testname = "dirprod_test::test_tt_1()";
...
void dirprod_test::test_tt_2() throw(libtest::test_exception) {

    static const char *testname = "dirprod_test::test_tt_2()";
...
void dirprod_test::test_te_1() throw(libtest::test_exception) {

    static const char *testname = "dirprod_test::test_te_1()";
...
void dirprod_test::test_et_1() throw(libtest::test_exception) {

    static const char *testname = "dirprod_test::test_et_1()";
...
void dirprod_test::test_ee_1() throw(libtest::test_exception) {

    static const char *testname = "dirprod_test::test_ee_1()";
    ...
    letter a, b, c, d;
    t3(a|b|c|d) = (1.5 * t1a(a|b) + 2.0 * t1b(a|b)) *
        (t2a(c|d) - 0.5 * t2b(c|d));
...
void dirprod_test::test_ee_2() throw(libtest::test_exception) {

    static const char *testname = "dirprod_test::test_ee_2()";
