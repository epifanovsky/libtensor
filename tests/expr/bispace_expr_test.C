...
void bispace_expr_test::test_sym_1() throw(libtest::test_exception) {
    ...
    if(!msk.equals(msk_ref)) {
        ...
        ss << "Unexpected mask: " << msk << " vs. " << msk_ref << " (ref).";
...
void bispace_expr_test::test_sym_2() throw(libtest::test_exception) {
    ...
    if(!msk1.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 1: " << msk1 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!msk2.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 2: " << msk2 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!msk3.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 3: " << msk3 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
...
void bispace_expr_test::test_sym_3() throw(libtest::test_exception) {
    ...
    if(!msk1.equals(msk1_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 1: " << msk1 << " vs. " << msk1_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!msk2.equals(msk2_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 2: " << msk2 << " vs. " << msk2_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
...
void bispace_expr_test::test_sym_4() throw(libtest::test_exception) {
    ...
    if(!msk3.equals(msk3_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 3: " << msk3 << " vs. " << msk3_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!msk4.equals(msk4_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 4: " << msk4 << " vs. " << msk4_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
...
void bispace_expr_test::test_sym_7() throw(libtest::test_exception) {
    ...
    if(!msk5.equals(msk5_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 5: " << msk5 << " vs. " << msk5_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!msk6.equals(msk6_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 6: " << msk6 << " vs. " << msk6_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
...
void bispace_expr_test::test_sym_10() throw(libtest::test_exception) {
    ...
    if(!m1.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 1: " << m1 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!m2.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 2: " << m2 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!m3.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 3: " << m3 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
    if(!m4.equals(msk_ref)) {
        std::ostringstream ss;
        ss << "Unexpected mask 4: " << m4 << " vs. " << msk_ref << " (ref).";
        fail_test(testname, __FILE__, __LINE__, ss.str().c_str());
    }
...
void bispace_expr_test::test_contains_1() throw(libtest::test_exception) {
    ...
    if(conta != 1) {
        fail_test(testname, __FILE__, __LINE__, "contains(a).");
    }
    if(contb != 1) {
        fail_test(testname, __FILE__, __LINE__, "contains(b).");
    }
    if(contc != 0) {
        fail_test(testname, __FILE__, __LINE__, "contains(c).");
    }
...
void bispace_expr_test::test_contains_3() throw(libtest::test_exception) {
    ...
    if(contd != 1) {
        fail_test(testname, __FILE__, __LINE__, "contains(d).");
    }
    if(conte != 0) {
        fail_test(testname, __FILE__, __LINE__, "contains(e).");
    }
...
void bispace_expr_test::test_contains_4() throw(libtest::test_exception) {
    ...
    if(contab != 1) {
        fail_test(testname, __FILE__, __LINE__, "contains(ab).");
    }
    if(contcd != 1) {
        fail_test(testname, __FILE__, __LINE__, "contains(cd).");
    }
