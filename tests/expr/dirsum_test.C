...
void dirsum_test::test_ee_2() throw(libtest::test_exception) {

    static const char *testname = "dirsum_test::test_ee_2()";
    ...
    btod_add<1> add1(t11, 2.0);
    add1.add_op(t12, 2.0);
    add1.perform(t1);
    btod_add<1> add2(t21, 2.0);
    add2.add_op(t22, 2.0);
    add2.perform(t2);
    btod_dirsum<1, 1>(t1, 1.0, t2, -1.0).perform(t3_ref);

    letter i, a;
    t3(i|a) = dirsum(2.0 * (t11(i) + t12(i)), -2.0 * (t21(a) + t22(a)));
...
void dirsum_test::test_ee_3() throw(libtest::test_exception) {

    static const char *testname = "dirsum_test::test_ee_3()";
    ...
    letter i, a;
    t3(i|a) = 0.5 * dirsum(2.0 * (t11(i) + t12(i)), -2.0 * (t21(a) + t22(a)));
