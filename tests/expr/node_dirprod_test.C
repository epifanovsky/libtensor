...
void node_dirprod_test::perform() throw(libtest::test_exception) {
...
void node_dirprod_test::test_1() throw(libtest::test_exception) {

    static const char testname[] = "node_dirprod_test::test_1()";

    try {

    node_ident t1(2), t2(3);
    node_dirprod c1(t1, t2);

    node_dirprod *c1copy = c1.clone();
...
void node_dirprod_test::test_2() throw(libtest::test_exception) {

    static const char testname[] = "node_dirprod_test::test_2()";
