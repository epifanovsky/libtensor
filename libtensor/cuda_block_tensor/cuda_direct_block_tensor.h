#ifndef LIBTENSOR_CUDA_DIRECT_BLOCK_TENSOR_H
#define LIBTENSOR_CUDA_DIRECT_BLOCK_TENSOR_H
...
class cuda_direct_block_tensor :
    public cuda_block_tensor_rd_i<N, T>,
    public noncopyable {
...
public:
    ...
    cuda_direct_block_tensor(operation_t &op) : m_gbt(op), m_ctrl(m_gbt) { }

    virtual ~cuda_direct_block_tensor() { }
    //@}
...
protected:
    //!    \name Implementation of libtensor::cuda_block_tensor_rd_i<N, T>
    //@{
...
#endif // LIBTENSOR_CUDA_DIRECT_BLOCK_TENSOR_H
