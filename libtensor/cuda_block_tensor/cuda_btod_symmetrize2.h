#ifndef LIBTENSOR_CUDA_BTOD_SYMMETRIZE2_H
#define LIBTENSOR_CUDA_BTOD_SYMMETRIZE2_H
 ...
 **/
template<size_t N>
class cuda_btod_symmetrize2 :
    public additive_gen_bto<N, cuda_btod_traits::bti_traits>,
    public timings< cuda_btod_symmetrize2<N> >,
    public noncopyable {
...
private:
    gen_bto_symmetrize2< N, cuda_btod_traits, cuda_btod_symmetrize2<N> > m_gbto;
...
public:
     ...
     **/
    cuda_btod_symmetrize2(additive_gen_bto<N, bti_traits> &op,
...
#endif // LIBTENSOR_CUDA_BTOD_SYMMETRIZE2_H
