#ifndef LIBTENSOR_KERN_ADD2_I_X_I_X_H
#define LIBTENSOR_KERN_ADD2_I_X_I_X_H
...
class kern_add2_i_x_i_x : public kernel_base<LA, 2, 1, T> {
public:
...
#endif // LIBTENSOR_KERN_ADD2_I_X_I_X_H
