#ifndef LIBTENSOR_KERN_MUL2_X_PQ_PQ_IMPL_H
#define LIBTENSOR_KERN_MUL2_X_PQ_PQ_IMPL_H
...
const char *kern_mul2_x_pq_pq<LA, T>::k_clazz = "kern_mul2_x_pq_pq";


template<typename LA, typename T>
void kern_mul2_x_pq_pq<LA, T>::run(
...
template<typename LA, typename T>
kernel_base<LA, 2, 1, T> *kern_mul2_x_pq_pq<LA, T>::match(
    ...
    return new kern_mul2_x_pq_pq(zz);
}


} // namespace libtensor

#endif // LIBTENSOR_KERN_MUL2_X_PQ_PQ_IMPL_H
