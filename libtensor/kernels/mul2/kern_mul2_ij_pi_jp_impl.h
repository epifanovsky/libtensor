#ifndef LIBTENSOR_KERN_MUL2_IJ_PI_JP_IMPL_H
#define LIBTENSOR_KERN_MUL2_IJ_PI_JP_IMPL_H
...
const char *kern_mul2_ij_pi_jp<LA, T>::k_clazz = "kern_mul2_ij_pi_jp";


template<typename LA, typename T>
void kern_mul2_ij_pi_jp<LA, T>::run(
...
template<typename LA, typename T>
kernel_base<LA, 2, 1, T> *kern_mul2_ij_pi_jp<LA, T>::match(
    ...
    return new kern_mul2_ij_pi_jp(zz);
}


} // namespace libtensor

#endif // LIBTENSOR_KERN_MUL2_IJ_PI_JP_IMPL_H
