#ifndef LIBTENSOR_KERN_MUL2_I_I_I_H
#define LIBTENSOR_KERN_MUL2_I_I_I_H
...
class kern_mul2_i_i_i : public kernel_base<LA, 2, 1, T> {
public:
...
#endif // LIBTENSOR_KERN_MUL2_I_I_I_H
