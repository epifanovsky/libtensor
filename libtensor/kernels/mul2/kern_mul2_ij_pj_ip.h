#ifndef LIBTENSOR_KERN_MUL2_IJ_PJ_IP_H
#define LIBTENSOR_KERN_MUL2_IJ_PJ_IP_H
...
class kern_mul2_ij_pj_ip : public kernel_base<LA, 2, 1, T> {
public:
...
#endif // LIBTENSOR_KERN_MUL2_IJ_PJ_IP_H
