#ifndef LIBTENSOR_KERN_MUL2_X_PQ_QP_H
#define LIBTENSOR_KERN_MUL2_X_PQ_QP_H
...
class kern_mul2_x_pq_qp : public kernel_base<LA, 2, 1, T> {
public:
...
#endif // LIBTENSOR_KERN_MUL2_X_PQ_QP_H
