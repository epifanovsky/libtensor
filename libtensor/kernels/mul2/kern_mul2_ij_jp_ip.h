#ifndef LIBTENSOR_KERN_MUL2_IJ_JP_IP_H
#define LIBTENSOR_KERN_MUL2_IJ_JP_IP_H
...
class kern_mul2_ij_jp_ip : public kernel_base<LA, 2, 1, T> {
public:
...
public:
    ...
    static kernel_base<LA, 2, 1, T> *match(const kern_mul2_i_ip_p<LA, T> &z,
...
#endif // LIBTENSOR_KERN_MUL2_IJ_JP_IP_H
