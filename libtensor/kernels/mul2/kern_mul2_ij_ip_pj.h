#ifndef LIBTENSOR_KERN_MUL2_IJ_IP_PJ_H
#define LIBTENSOR_KERN_MUL2_IJ_IP_PJ_H
...
class kern_mul2_ij_ip_pj : public kernel_base<LA, 2, 1, T> {
public:
...
#endif // LIBTENSOR_KERN_MUL2_IJ_IP_PJ_H
