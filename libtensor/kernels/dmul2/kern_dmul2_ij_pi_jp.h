#ifndef LIBTENSOR_KERN_DMUL2_IJ_PI_JP_H
#define LIBTENSOR_KERN_DMUL2_IJ_PI_JP_H
...
class kern_dmul2_ij_pi_jp : public kernel_base<LA, 2, 1, double> {
public:
...
public:
    ...
    static kernel_base<LA, 2, 1, double> *match(const kern_dmul2_i_pi_p<LA> &z,
...
#endif // LIBTENSOR_KERN_DMUL2_IJ_PI_JP_H
