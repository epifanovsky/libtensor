...
//    if(kern = kern_mul_i_pi_p::match(zz, in, out)) return kern;
//    if(kern = kern_mul_ij_i_j::match(zz, in, out)) return kern;
//    if(kern = kern_mul_ij_j_i::match(zz, in, out)) return kern;
