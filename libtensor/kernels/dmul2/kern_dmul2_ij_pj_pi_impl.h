...
template<typename LA>
void kern_dmul2_ij_pj_pi<LA>::run(const loop_registers<2, 1> &r) {

    LA::mul2_ij_pi_pj_x(0, m_ni, m_nj, m_np, r.m_ptra[1], m_spb,
        r.m_ptra[0], m_spa, r.m_ptrb[0], m_sic, m_d);
}


template<typename LA>
kernel_base<2, 1> *kern_dmul2_ij_pj_pi<LA>::match(
