...
template<typename LA> class kern_dmul2_i_p_pi;
...
class kern_dmul2_i_x_i : public kernel_base<LA, 2, 1, double> {
    friend class kern_dmul2_i_p_pi<LA>;
...
public:
    ...
    static kernel_base<LA, 2, 1, double> *match(const kern_dmul2<LA> &z,
