...
template<typename LA>
void kern_dmul2_i_x_i<LA>::run(const loop_registers<2, 1> &r) {

    LA::mul2_i_i_x(0, m_ni, r.m_ptra[1], m_sib, r.m_ptra[0][0] * m_d,
        r.m_ptrb[0], m_sic);
}


template<typename LA>
kernel_base<2, 1> *kern_dmul2_i_x_i<LA>::match(const kern_dmul2<LA> &z,
