#ifndef LIBTENSOR_ALGO_IJKL_IPLQ_PKJQ_H
#define LIBTENSOR_ALGO_IJKL_IPLQ_PKJQ_H
...
void algo_ijkl_iplq_pkjq(const double *a, const double *b, double *c, double d,
...
#endif // LIBTENSOR_ALGO_IJKL_IPLQ_PKJQ_H
