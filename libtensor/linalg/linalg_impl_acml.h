#ifndef LIBTENSOR_LINALG_IMPL_ACML_H
#define LIBTENSOR_LINALG_IMPL_ACML_H
...
/**	\brief Implementation of linear algebra using ACML

	\sa linalg_impl_generic

	\ingroup libtensor_linalg
 **/
class linalg_impl_acml : public linalg_impl_generic {
public:
...
#endif // LIBTENSOR_LINALG_IMPL_ACML_H
