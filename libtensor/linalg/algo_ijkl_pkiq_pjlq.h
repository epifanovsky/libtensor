#ifndef LIBTENSOR_ALGO_IJKL_PKIQ_PJLQ_H
#define LIBTENSOR_ALGO_IJKL_PKIQ_PJLQ_H
...
void algo_ijkl_pkiq_pjlq(const double *a, const double *b, double *c, double d,
...
#endif // LIBTENSOR_ALGO_IJKL_PKIQ_PJLQ_H
