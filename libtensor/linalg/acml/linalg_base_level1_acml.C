...
const char *linalg_base_level1_acml::k_clazz = "acml";


void linalg_base_level1_acml::add_i_i_x_x(
    size_t ni,
...
void linalg_base_level1_acml::i_x(
    size_t ni,
    double a,
    double *c, size_t sic) {
...
double linalg_base_level1_acml::x_p_p(
    size_t np,
...
void linalg_base_level1_acml::i_i_x(
    size_t ni,
