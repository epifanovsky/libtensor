...
const char *linalg_acml_level2::k_clazz = "acml";


void linalg_acml_level2::i_ip_p_x(
    size_t ni, size_t np,
...
void linalg_acml_level2::i_pi_p_x(
    size_t ni, size_t np,
...
void linalg_acml_level2::ij_i_j_x(
    size_t ni, size_t nj,
    const double *a, size_t sia,
