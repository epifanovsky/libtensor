#ifndef LIBTENSOR_ALGO_IJKL_IPLQ_PKQJ_H
#define LIBTENSOR_ALGO_IJKL_IPLQ_PKQJ_H
...
void algo_ijkl_iplq_pkqj(const double *a, const double *b, double *c, double d,
	...
	//	c_kjil += d * b_pqkj a_ilpq

	Impl::ij_pi_jp(b1, a1, c1, d, nkj, nil, npq, nil1, npq1, nkj1);
...
#endif // LIBTENSOR_ALGO_IJKL_IPLQ_PKQJ_H
