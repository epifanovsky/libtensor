#ifndef LIBTENSOR_ALGO_IJKL_PIQL_KPQJ_H
#define LIBTENSOR_ALGO_IJKL_PIQL_KPQJ_H
...
void algo_ijkl_piql_kpqj(const double *a, const double *b, double *c, double d,
...
#endif // LIBTENSOR_ALGO_IJKL_PIQL_KPQJ_H
