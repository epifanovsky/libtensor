#ifndef LIBTENSOR_ALGO_IJKL_IPQL_PKQJ_H
#define LIBTENSOR_ALGO_IJKL_IPQL_PKQJ_H
...
void algo_ijkl_ipql_pkqj(const double *a, const double *b, double *c, double d,
...
#endif // LIBTENSOR_ALGO_IJKL_IPQL_PKQJ_H
