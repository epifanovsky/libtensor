#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_PLIQ_JPQK_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_PLIQ_JPQK_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_pliq_jpqk_x(
    ...
    //  b1_pqjk <- b_jpqk
    trp_ijkl_kijl::transpose(np, nq, nj, nk, b, nq * nk, b1, njk1);

    //  c1_jkil <- c_ijkl
    trp_ijkl_kijl::transpose(nj, nk, ni, nl, c, nk * nl, c1, nil1);

    //  c1_jkil += d * b1_pqjk a1_ilpq
    L3::ij_pi_jp_x(njk, nil, npq, b1, njk1, a1, npq1, c1, nil1, d);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_PLIQ_JPQK_X_H
