#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJK_PIQK_JPQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJK_PIQK_JPQ_X_H
...
void linalg_base_level5_adaptive<M, L1, L2, L3>::ijk_piqk_jpq_x(
    ...
    //  c1_jik += d * b_jpq a1_pqik
    L3::ij_ip_pj_x(nj, nik, npq, b, npq, a1, nik1, c1, nik1, d);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJK_PIQK_JPQ_X_H
