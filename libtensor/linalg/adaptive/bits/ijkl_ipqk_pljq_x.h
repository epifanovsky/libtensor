#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQK_PLJQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQK_PLJQ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_ipqk_pljq_x(
	...
	//	a1_pqik <- a_ipqk
	trp_ijkl_kijl::transpose(np, nq, ni, nk, a, nq * nk, a1, nik1);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQK_PLJQ_X_H
