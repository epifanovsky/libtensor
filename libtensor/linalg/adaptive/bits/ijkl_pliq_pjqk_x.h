#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_PLIQ_PJQK_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_PLIQ_PJQK_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_pliq_pjqk_x(
	...
	//	b1_pqjk <- b_pjqk
	trp_ijkl_ikjl::transpose(np, nq, nj, nk, b, nq * nk, b1, njk1);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_PLIQ_PJQK_X_H
