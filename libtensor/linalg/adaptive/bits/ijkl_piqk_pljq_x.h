#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_PIQK_PLJQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_PIQK_PLJQ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_piqk_pljq_x(
    ...
    double *a1 = M::allocate(npq * nik1);
    double *b1 = M::allocate(njl * npq1);
    double *c1 = M::allocate(nik * njl1);

    //  a1_pqik <- a_piqk
    trp_ijkl_ikjl::transpose(np, nq, ni, nk, a, nq * nk, a1, nik1);

    //  b1_jlpq <- b_pljq
    trp_ijkl_kjil::transpose(nj, nl, np, nq, b, nj * nq, b1, npq1);

    //  c1_ikjl <- c_ijkl
    trp_ijkl_ikjl::transpose(ni, nk, nj, nl, c, nk * nl, c1, njl1);

    //  c1_ikjl += d * a1_pqik b1_jlpq
    L3::ij_pi_jp_x(nik, njl, npq, a1, nik1, b1, npq1, c1, njl1, d);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_PIQK_PLJQ_X_H
