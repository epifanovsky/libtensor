#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPLQ_PKQJ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPLQ_PKQJ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_iplq_pkqj_x(
    ...
    //  a1_ilpq <- a_iplq
    trp_ijkl_ikjl::transpose(ni, nl, np, nq, a, nl * nq, a1, npq1);

    //  b1_pqkj <- b_pkqj
    trp_ijkl_ikjl::transpose(np, nq, nk, nj, b, nq * nj, b1, nkj1);

    //  c1_kjil <- c_ijkl
    trp_ijkl_kjil::transpose(nk, nj, ni, nl, c, nk * nl, c1, nil1);

    //  c1_kjil += d * b1_pqkj a1_ilpq
    L3::ij_pi_jp_x(nkj, nil, npq, b1, nkj1, a1, npq1, c1, nil1, d);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPLQ_PKQJ_X_H
