#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_PIKQ_PLJQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_PIKQ_PLJQ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_pikq_pljq_x(
	...
	//	a1_ikpq <- a_pikq
	trp_ijkl_kijl::transpose(ni, nk, np, nq, a, nk * nq, a1, npq1);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_PIKQ_PLJQ_X_H
