#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_QKPJ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_QKPJ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_ipql_qkpj_x(
    ...
    //  b1_pqkj <- b_qkpj
    trp_ijkl_jkil::transpose(np, nq, nk, nj, b, np * nj, b1, nkj1);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_QKPJ_X_H
