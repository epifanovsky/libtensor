#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_QPKJ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_QPKJ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_ipql_qpkj_x(
    ...
    //  a1_qpil <- a_ipql
    trp_ijkl_kjil::transpose(nq, np, ni, nl, a, nq * nl, a1, nil1);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_QPKJ_X_H
