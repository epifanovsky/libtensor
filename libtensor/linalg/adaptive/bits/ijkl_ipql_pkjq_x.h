#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_PKJQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_PKJQ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_ipql_pkjq_x(
    ...
    //  a1_pqil <- a_ipql
    trp_ijkl_kijl::transpose(np, nq, ni, nl, a, nq * nl, a1, nil1);

    //  b1_kjpq <- b_pkjq
    trp_ijkl_kijl::transpose(nk, nj, np, nq, b, nj * nq, b1, npq1);

    //  c1_kjil <- c_ijkl
    trp_ijkl_kjil::transpose(nk, nj, ni, nl, c, nk * nl, c1, nil1);

    //  c1_kjil += d * b1_kjpq a1_pqil
    L3::ij_ip_pj_x(nkj, nil, npq, b1, npq1, a1, nil1, c1, nil1, d);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPQL_PKJQ_X_H
