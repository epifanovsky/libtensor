#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPKQ_PLJQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPKQ_PLJQ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_ipkq_pljq_x(
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_IPKQ_PLJQ_X_H
