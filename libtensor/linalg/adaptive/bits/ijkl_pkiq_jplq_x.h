#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJKL_PKIQ_JPLQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJKL_PKIQ_JPLQ_X_H
...
void linalg_base_level6_adaptive<M, L1, L2, L3>::ijkl_pkiq_jplq_x(
	...
	//	b1_jlpq <- b_jplq
	trp_ijkl_ikjl(nj, nl, np, nq, b, nl * nq, b1, npq1);
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJKL_PKIQ_JPLQ_X_H
