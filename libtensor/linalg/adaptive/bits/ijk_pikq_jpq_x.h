#ifndef LIBTENSOR_LINALG_ADAPTIVE_IJK_PIKQ_JPQ_X_H
#define LIBTENSOR_LINALG_ADAPTIVE_IJK_PIKQ_JPQ_X_H
...
void linalg_base_level5_adaptive<M, L1, L2, L3>::ijk_pikq_jpq_x(
...
#endif // LIBTENSOR_LINALG_ADAPTIVE_IJK_PIKQ_JPQ_X_H
