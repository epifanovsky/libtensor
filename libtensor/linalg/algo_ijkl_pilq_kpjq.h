#ifndef LIBTENSOR_ALGO_IJKL_PILQ_KPJQ_H
#define LIBTENSOR_ALGO_IJKL_PILQ_KPJQ_H
...
void algo_ijkl_pilq_kpjq(const double *a, const double *b, double *c, double d,
...
#endif // LIBTENSOR_ALGO_IJKL_PILQ_KPJQ_H
