...
const char *linalg_base_level1_mkl::k_clazz = "mkl";


void linalg_base_level1_mkl::add_i_i_x_x(
    size_t ni,
...
void linalg_base_level1_mkl::i_i(
    size_t ni,
...
void linalg_base_level1_mkl::i_x(
    size_t ni,
    double a,
    double *c, size_t sic) {
...
double linalg_base_level1_mkl::x_p_p(
    size_t np,
...
void linalg_base_level1_mkl::i_i_x(
    size_t ni,
    const double *a, size_t sia,
    double b,
    double *c, size_t sic) {
...
void linalg_base_level1_mkl::i_i_i_x(
    size_t ni,
    const double *a, size_t sia,
