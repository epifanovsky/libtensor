...
void linalg_mkl_level2::i_ip_p_x(
    size_t ni, size_t np,
    const double *a, size_t sia,
...
void linalg_mkl_level2::i_pi_p_x(
    size_t ni, size_t np,
...
void linalg_mkl_level2::ij_i_j_x(
    size_t ni, size_t nj,
    const double *a, size_t sia,
...
void linalg_mkl_level2::ij_ij_x(
    size_t ni, size_t nj,
    const double *a, size_t sia,
    double b,
    double *c, size_t sic) {
...
void linalg_mkl_level2::ij_ji_x(
    size_t ni, size_t nj,
    const double *a, size_t sja,
    double b,
    double *c, size_t sic) {
