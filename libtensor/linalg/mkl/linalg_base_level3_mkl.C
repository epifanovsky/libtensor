...
const char *linalg_base_level3_mkl::k_clazz = "mkl";


void linalg_base_level3_mkl::ij_ip_jp_x(
...
void linalg_base_level3_mkl::ij_ip_pj_x(
    size_t ni, size_t nj, size_t np,
    const double *a, size_t sia,
...
void linalg_base_level3_mkl::ij_pi_jp_x(
    size_t ni, size_t nj, size_t np,
...
void linalg_base_level3_mkl::ij_pi_pj_x(
    size_t ni, size_t nj, size_t np,
    const double *a, size_t spa,
    const double *b, size_t spb,
    double *c, size_t sic,
