#ifndef LIBTENSOR_ALGO_IJKL_PKIQ_PJQL_H
#define LIBTENSOR_ALGO_IJKL_PKIQ_PJQL_H
...
void algo_ijkl_pkiq_pjql(const double *a, const double *b, double *c, double d,
...
#endif // LIBTENSOR_ALGO_IJKL_PKIQ_PJQL_H
