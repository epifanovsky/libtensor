...
//~ template class btod_contract2<0, 0, 1>;
//~ template class btod_contract2<0, 0, 2>;
//~ template class btod_contract2<0, 0, 3>;
//~ template class btod_contract2<0, 0, 4>;
//~ template class btod_contract2<0, 0, 5>;
//~ template class btod_contract2<0, 0, 6>;
