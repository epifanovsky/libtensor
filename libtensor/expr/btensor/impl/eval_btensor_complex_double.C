...
eval_btensor< std::complex<double> >::~eval_btensor< std::complex<double> >() {

}


bool eval_btensor< std::complex<double> >::can_evaluate(
...
void eval_btensor< std::complex<double> >::evaluate(
    const expr_tree &tree) const {
