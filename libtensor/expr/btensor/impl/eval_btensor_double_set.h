#ifndef LIBTENSOR_EXPR_EVAL_BTENSOR_DOUBLE_SET_H
#define LIBTENSOR_EXPR_EVAL_BTENSOR_DOUBLE_SET_H
...
template<size_t N>
class set : public eval_btensor_evaluator_i<N, double> {
public:
    enum {
...
#endif // LIBTENSOR_EXPR_EVAL_BTENSOR_DOUBLE_SET_H
