#ifndef LIBTENSOR_UNASSIGNED_EXPRESSION_NODE_DIRPROD_H
#define LIBTENSOR_UNASSIGNED_EXPRESSION_NODE_DIRPROD_H

#include "../unassigned_expression.h"
#include "../expression.h"
#include "expression_node_dirprod.h"

namespace libtensor {


/** \brief Expression node: direct product of two sub-expressions
...
class unassigned_expression_node_dirprod :
...
public:
     ...
     **/
    unassigned_expression_node_dirprod(
     ...
     **/
    virtual ~unassigned_expression_node_dirprod() { }
...
template<size_t N, size_t M, typename T>
void unassigned_expression_node_dirprod<N, M, T>::translate(
    ...
    expression_node_dirprod<N, M, T> n(a, b, perm);
    e.add_node(n);
}
...
#endif // LIBTENSOR_UNASSIGNED_EXPRESSION_NODE_DIRPROD_H
