#ifndef LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_DIV_H
#define LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_DIV_H
...
template<size_t N>
class div : public eval_ctf_btensor_evaluator_i<N, double> {
public:
    enum {
...
#endif // LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_DIV_H
