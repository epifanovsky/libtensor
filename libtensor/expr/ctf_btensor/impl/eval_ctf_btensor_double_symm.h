#ifndef LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SYMM_H
#define LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SYMM_H
...
template<size_t N>
class symm : public eval_ctf_btensor_evaluator_i<N, double> {
public:
    enum {
...
#endif // LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SYMM_H
