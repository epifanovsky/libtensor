#ifndef LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SCALE_H
#define LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SCALE_H
...
#endif // LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SCALE_H
