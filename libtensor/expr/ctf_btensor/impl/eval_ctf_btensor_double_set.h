#ifndef LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SET_H
#define LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SET_H
...
template<size_t N>
class set : public eval_ctf_btensor_evaluator_i<N, double> {
public:
    enum {
...
public:
     ...
     **/
    set(const expr_tree &tree, node_id_t id,
...
#endif // LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_SET_H
