#ifndef LIBTENSOR_EXPR_EVAL_TREE_BUILDER_CTF_BTENSOR_H
#define LIBTENSOR_EXPR_EVAL_TREE_BUILDER_CTF_BTENSOR_H
...
class eval_tree_builder_ctf_btensor {
public:
...
public:
    eval_tree_builder_ctf_btensor(const expr_tree &tr) :
        m_tree(tr), m_order(0)
    { }
...
#endif // LIBTENSOR_EXPR_EVAL_TREE_BUILDER_CTF_BTENSOR_H
