#ifndef LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_DIRSUM_H
#define LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_DIRSUM_H
...
template<size_t NC>
class dirsum : public eval_ctf_btensor_evaluator_i<NC, double> {
public:
    enum {
...
#endif // LIBTENSOR_EXPR_EVAL_CTF_BTENSOR_DOUBLE_DIRSUM_H
