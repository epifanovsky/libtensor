...
template class se_perm<4, double>;
template class se_perm<5, double>;
template class se_perm<6, double>;
template class se_perm<7, double>;
template class se_perm<8, double>;
template class se_perm<9, double>;
