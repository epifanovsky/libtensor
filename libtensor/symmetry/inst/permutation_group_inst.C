...
template class permutation_group<13, double>;
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<1, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<2, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<3, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<4, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<5, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<6, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<7, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<8, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<9, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<10, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<11, double> &);
template void permutation_group<13, double>::project_down(
    const mask<13> &msk, permutation_group<12, double> &);

template class permutation_group<14, double>;
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<1, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<2, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<3, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<4, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<5, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<6, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<7, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<8, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<9, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<10, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<11, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<12, double> &);
template void permutation_group<14, double>::project_down(
    const mask<14> &msk, permutation_group<13, double> &);

template class permutation_group<15, double>;
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<1, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<2, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<3, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<4, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<5, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<6, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<7, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<8, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<9, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<10, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<11, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<12, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<13, double> &);
template void permutation_group<15, double>::project_down(
    const mask<15> &msk, permutation_group<14, double> &);

template class permutation_group<16, double>;
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<1, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<2, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<3, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<4, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<5, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<6, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<7, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<8, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<9, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<10, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<11, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<12, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<13, double> &);
template void permutation_group<16, double>::project_down(
    const mask<16> &msk, permutation_group<14, double> &);
template void permutation_group<16, double>::project_down(
