#ifndef LIBTENSOR_SO_PERMUTE_HANDLERS_H
#define LIBTENSOR_SO_PERMUTE_HANDLERS_H
...
#include "se_part.h"
#include "se_perm.h"
//#include "label/so_permute_impl_label.h"
#include "part/so_permute_impl_part.h"
#include "perm/so_permute_impl_perm.h"

namespace libtensor {


template<size_t N, typename T>
class symmetry_operation_handlers< so_permute<N, T> > {
public:
...
#endif // LIBTENSOR_SO_PERMUTE_HANDLERS_H
