...
#include "se_part.h"
#include "se_perm.h"
#include "label/so_concat_impl_label.h"
#include "part/so_concat_impl_part.h"
#include "perm/so_concat_impl_perm.h"

namespace libtensor {


template<size_t N, size_t M, typename T>
class symmetry_operation_handlers< so_concat<N, M, T> > {
public:
