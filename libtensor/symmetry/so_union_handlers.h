#ifndef LIBTENSOR_SO_UNION_HANDLERS_H
#define LIBTENSOR_SO_UNION_HANDLERS_H

#include "symmetry_operation_dispatcher.h"
#include "symmetry_operation_handlers.h"
#include "so_union_impl_perm.h"

namespace libtensor {


template<size_t N, typename T>
class symmetry_operation_handlers< so_union<N, T> > {
public:
...
#endif // LIBTENSOR_SO_UNION_HANDLERS_H
