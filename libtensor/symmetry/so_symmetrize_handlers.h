#ifndef LIBTENSOR_SO_SYMMETRIZE_HANDLERS_H
#define LIBTENSOR_SO_SYMMETRIZE_HANDLERS_H
...
#include "se_part.h"
#include "se_perm.h"
#include "so_symmetrize_impl_label.h"
#include "so_symmetrize_impl_part.h"
#include "so_symmetrize_impl_perm.h"

namespace libtensor {


template<size_t N, typename T>
class symmetry_operation_handlers< so_symmetrize<N, T> > {
public:
...
#endif // LIBTENSOR_SO_SYMMETRIZE_HANDLERS_H
