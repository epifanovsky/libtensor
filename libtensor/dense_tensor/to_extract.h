#ifndef LIBTENSOR_TO_EXTRACT_H
#define LIBTENSOR_TO_EXTRACT_H
...
class to_extract : public timings< to_extract<N, M, T> >, public noncopyable {
public:
...
public:
    ...
    **/
    to_extract(dense_tensor_rd_i<NA, T> &t,
    ...
    **/
    to_extract(dense_tensor_rd_i<NA, T> &t, const mask<NA> &m,
    ...
    **/
    to_extract(dense_tensor_rd_i<NA, T> &t, const mask<NA> &m,
            const index<NA> &idx, const permutation<NB> &p, T c = 1.0);
...
using tod_extract = to_extract<N, M, double>;

} // namespace libtensor

#endif // LIBTENSOR_TO_EXTRACT_H
