#ifndef LIBTENSOR_GEN_BTO_CONTRACT2_SIMPLE_H
#define LIBTENSOR_GEN_BTO_CONTRACT2_SIMPLE_H
...
/** \brief Computes the contraction of two general block tensors
    ...
    This is a simple version of the algorithm without batching
    (as opposed to gen_bto_contract2).
...
class gen_bto_contract2_simple : public timings<Timed>, public noncopyable {
private:
    enum {
...
#endif // LIBTENSOR_GEN_BTO_CONTRACT2_SIMPLE_H
