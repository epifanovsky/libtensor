#ifndef LIBTENSOR_GEN_BTO_SHIFT_DIAG_IMPL_H
#define LIBTENSOR_GEN_BTO_SHIFT_DIAG_IMPL_H

#include <libtensor/defs.h>
#include <libtensor/exception.h>
#include <libtensor/core/orbit.h>
#include <libtensor/block_tensor/block_tensor_i.h>
#include "../gen_bto_shift_diag.h"
...
const char gen_bto_shift_diag<N, Traits>::k_clazz[] =
        "gen_bto_shift_diag<N, Traits>";


template<size_t N, typename Traits>
gen_bto_shift_diag<N, Traits>::gen_bto_shift_diag(
...
template<size_t N, typename Traits>
void gen_bto_shift_diag<N, Traits>::perform(
    ...
    // Don't do anything if shift is zero
    if (Traits::is_zero(m_v)) return;
    ...
    do {
        ...
        to_set_diag(m_msk, m_v).perform(false, blk);
        ctrl.ret_block(i1);
