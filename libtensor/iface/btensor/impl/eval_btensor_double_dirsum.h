#ifndef LIBTENSOR_EVAL_BTENSOR_DOUBLE_DIRSUM_H
#define LIBTENSOR_EVAL_BTENSOR_DOUBLE_DIRSUM_H
...
public:
    dirsum(const expr::expr_tree &tr, node_id_t &id, bool add) :
...
#endif // LIBTENSOR_EVAL_BTENSOR_DOUBLE_DIRSUM_H
