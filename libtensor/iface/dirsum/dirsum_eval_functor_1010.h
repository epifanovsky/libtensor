#ifndef LIBTENSOR_LABELED_BTENSOR_EXPR_DIRSUM_EVAL_FUNCTOR_1010_H
#define LIBTENSOR_LABELED_BTENSOR_EXPR_DIRSUM_EVAL_FUNCTOR_1010_H
...
/**	\brief Functor for evaluating direct sums (tensor + tensor)

	\ingroup libtensor_btensor_expr
 **/
template<size_t N, size_t M, typename T, typename E1, typename E2>
class dirsum_eval_functor<N, M, T, E1, E2, 1, 0, 1, 0> {
public:
...
template<size_t N, size_t M, typename T, typename E1, typename E2>
const char *dirsum_eval_functor<N, M, T, E1, E2, 1, 0, 1, 0>::k_clazz =
	"dirsum_eval_functor<N, M, T, E1, E2, 1, 0, 1, 0>";


template<size_t N, size_t M, typename T, typename E1, typename E2>
dirsum_eval_functor<N, M, T, E1, E2, 1, 0, 1, 0>::dirsum_eval_functor(
	...
	m_op(m_arg_a.get_btensor(), m_arg_a.get_coeff(), m_arg_b.get_btensor(),
		m_arg_b.get_coeff(), m_perm_bld.get_perm()),
	m_arg(m_op, 1.0) {
...
#endif // LIBTENSOR_LABELED_BTENSOR_EXPR_DIRSUM_EVAL_FUNCTOR_1010_H
