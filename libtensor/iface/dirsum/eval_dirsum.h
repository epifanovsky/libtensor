...
template<size_t N, size_t M, typename T, typename E1, typename E2>
const char *eval_dirsum<N, M, T, E1, E2>::k_clazz =
	"eval_dirsum<N, M, T, E1, E2>";


template<size_t N, size_t M, typename T, typename E1, typename E2>
template<int Dummy>
struct eval_dirsum<N, M, T, E1, E2>::narg<oper_tag, Dummy> {
	static const size_t k_narg = 1;
};


template<size_t N, size_t M, typename T, typename E1, typename E2>
inline eval_dirsum<N, M, T, E1, E2>::eval_dirsum(
...
template<size_t N, size_t M, typename T, typename E1, typename E2>
inline void eval_dirsum<N, M, T, E1, E2>::prepare() {
...
template<size_t N, size_t M, typename T, typename E1, typename E2>
inline void eval_dirsum<N, M, T, E1, E2>::clean() {
...
template<size_t N, size_t M, typename T, typename E1, typename E2>
template<typename Tag>
arg<N + M, T, Tag> eval_dirsum<N, M, T, E1, E2>::get_arg(
...
template<size_t N, size_t M, typename T, typename E1, typename E2>
arg<N + M, T, oper_tag> eval_dirsum<N, M, T, E1, E2>::get_arg(
...
#endif // LIBTENSOR_LABELED_BTENSOR_EXPR_EVAL_DIRSUM_H
