#ifndef LIBTENSOR_LABELED_BTENSOR_EXPR_SYMM3_EVAL_H
#define LIBTENSOR_LABELED_BTENSOR_EXPR_SYMM3_EVAL_H

#include "../../btod/btod_symmetrize3.h"
...
public:
	/**	\brief Initializes the container with given expression and
			result recipient
	 **/
	symm3_eval(expression_t &expr, const letter_expr<N> &label);
...
template<size_t N, bool Sym, typename T, typename SubCore>
const char *symm3_eval<N, Sym, T, SubCore>::k_clazz =
	"symm3_eval<N, Sym, T, SubCore>";
...
template<size_t N, bool Sym, typename T, typename SubCore>
symm3_eval<N, Sym, T, SubCore>::symm3_eval(expression_t &expr,
...
template<size_t N, bool Sym, typename T, typename SubCore>
symm3_eval<N, Sym, T, SubCore>::~symm3_eval() {
...
template<size_t N, bool Sym, typename T, typename SubCore>
void symm3_eval<N, Sym, T, SubCore>::prepare() {
...
template<size_t N, bool Sym, typename T, typename SubCore>
void symm3_eval<N, Sym, T, SubCore>::clean() {
...
template<size_t N, bool Sym, typename T, typename SubCore>
void symm3_eval<N, Sym, T, SubCore>::create_arg() {
...
template<size_t N, bool Sym, typename T, typename SubCore>
template<typename Tag>
arg<N, T, Tag> symm3_eval<N, Sym, T, SubCore>::get_arg(const Tag &tag,
	size_t i) const {
...
template<size_t N, bool Sym, typename T, typename SubCore>
arg<N, T, oper_tag> symm3_eval<N, Sym, T, SubCore>::get_arg(
...
#endif // LIBTENSOR_LABELED_BTENSOR_EXPR_SYMM3_EVAL_H
