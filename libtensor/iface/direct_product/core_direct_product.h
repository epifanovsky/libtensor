...
template<size_t N, size_t M, typename T> class eval_direct_product;
...
class core_direct_product : public expr_core_i<N + M, T> {
public:
    static const char k_clazz[]; //!< Class name

public:
     //! Evaluating container type
    typedef eval_direct_product<N, M, T> eval_container_t;
...
public:
     ...
     **/
    core_direct_product(const expr<N, T> &expr1, const expr<M, T> &expr2);
...
template<size_t N, size_t M, typename T>
const char *core_direct_product<N, M, T>::k_clazz[] =
    "core_direct_product<N, M, T>";


template<size_t N, size_t M, typename T>
core_direct_product<N, M, T>::core_direct_product(
    const expr<N, T> &expr1, const expr<M, T> &expr2) :

    m_expr1(expr1), m_expr2(expr2), m_defout(0) {

    static const char method[] =
        "core_direct_product(const expr<N, T>&, const expr<M, T>&)";
...
template<size_t N, size_t M, typename T>
bool core_direct_product<N, M, T>::contains(const letter &let) const {
...
template<size_t N, size_t M, typename T>
size_t core_direct_product<N, M, T>::index_of(const letter &let) const {
...
template<size_t N, size_t M, typename T>
const letter&core_direct_product<N, M, T>::letter_at(size_t i) const {
