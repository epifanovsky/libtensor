...
#include "../bto_copy_xm.h"

namespace libtensor {


template<size_t N, typename T>
const char bto_copy_xm<N, T>::k_clazz[] = "bto_copy_xm<N, T>";


template<size_t N, typename T>
void bto_copy_xm<N, T>::perform(gen_block_stream_i<N, bti_traits> &out) {
...
template<size_t N, typename T>
void bto_copy_xm<N, T>::perform(gen_block_tensor_i<N, bti_traits> &btb) {
...
template<size_t N, typename T>
void bto_copy_xm<N, T>::perform(block_tensor_i<N, T> &btb, T c) {
...
template<size_t N, typename T>
void bto_copy_xm<N, T>::compute_block(
    bool zero,
    const index<N> &ib,
