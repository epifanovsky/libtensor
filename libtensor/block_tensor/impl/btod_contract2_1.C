...
template class btod_contract2<0, 1, 6>;
template class btod_contract2<0, 1, 7>;
...
template class btod_contract2<1, 0, 6>;
template class btod_contract2<1, 0, 7>;
