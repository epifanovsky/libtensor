...
template class btod_contract2<3, 3, 4>;
template class btod_contract2<3, 3, 5>;
template class btod_contract2<4, 2, 0>;
template class btod_contract2<4, 2, 1>;
template class btod_contract2<4, 2, 2>;
template class btod_contract2<4, 2, 3>;
template class btod_contract2<4, 2, 4>;
template class btod_contract2<5, 1, 0>;
template class btod_contract2<5, 1, 1>;
template class btod_contract2<5, 1, 2>;
template class btod_contract2<5, 1, 3>;
template class btod_contract2<6, 0, 1>;
template class btod_contract2<6, 0, 2>;
