...
template class gen_bto_dirsum<1, 6, btod_traits, btod_dirsum<1, 6> >;
template class gen_bto_dirsum<1, 7, btod_traits, btod_dirsum<1, 7> >;
...
template class gen_bto_dirsum<2, 5, btod_traits, btod_dirsum<2, 5> >;
template class gen_bto_dirsum<2, 6, btod_traits, btod_dirsum<2, 6> >;
...
template class gen_bto_dirsum<3, 4, btod_traits, btod_dirsum<3, 4> >;
template class gen_bto_dirsum<3, 5, btod_traits, btod_dirsum<3, 5> >;
...
template class gen_bto_dirsum<4, 3, btod_traits, btod_dirsum<4, 3> >;
...
template class gen_bto_dirsum<5, 2, btod_traits, btod_dirsum<5, 2> >;
template class gen_bto_dirsum<5, 3, btod_traits, btod_dirsum<5, 3> >;
template class gen_bto_dirsum<6, 1, btod_traits, btod_dirsum<6, 1> >;
template class gen_bto_dirsum<6, 2, btod_traits, btod_dirsum<6, 2> >;
template class gen_bto_dirsum<7, 1, btod_traits, btod_dirsum<7, 1> >;
...
template class btod_dirsum<1, 6>;
template class btod_dirsum<1, 7>;
template class btod_dirsum<2, 1>;
template class btod_dirsum<2, 2>;
template class btod_dirsum<2, 3>;
template class btod_dirsum<2, 4>;
template class btod_dirsum<2, 5>;
template class btod_dirsum<2, 6>;
template class btod_dirsum<3, 1>;
template class btod_dirsum<3, 2>;
template class btod_dirsum<3, 3>;
template class btod_dirsum<3, 4>;
template class btod_dirsum<3, 5>;
template class btod_dirsum<4, 1>;
template class btod_dirsum<4, 2>;
template class btod_dirsum<4, 3>;
template class btod_dirsum<4, 4>;
template class btod_dirsum<5, 1>;
template class btod_dirsum<5, 2>;
template class btod_dirsum<5, 3>;
template class btod_dirsum<6, 1>;
template class btod_dirsum<6, 2>;
template class btod_dirsum<7, 1>;
