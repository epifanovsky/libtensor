...
template class gen_bto_diag< 7, 2, btod_traits, btod_diag<7, 2> >;
template class gen_bto_diag< 7, 3, btod_traits, btod_diag<7, 3> >;
template class gen_bto_diag< 7, 4, btod_traits, btod_diag<7, 4> >;
template class gen_bto_diag< 7, 5, btod_traits, btod_diag<7, 5> >;
template class gen_bto_diag< 7, 6, btod_traits, btod_diag<7, 6> >;
template class gen_bto_diag< 7, 7, btod_traits, btod_diag<7, 7> >;
template class gen_bto_diag< 8, 2, btod_traits, btod_diag<8, 2> >;
template class gen_bto_diag< 8, 3, btod_traits, btod_diag<8, 3> >;
template class gen_bto_diag< 8, 4, btod_traits, btod_diag<8, 4> >;
template class gen_bto_diag< 8, 5, btod_traits, btod_diag<8, 5> >;
template class gen_bto_diag< 8, 6, btod_traits, btod_diag<8, 6> >;
template class gen_bto_diag< 8, 7, btod_traits, btod_diag<8, 7> >;
template class gen_bto_diag< 8, 8, btod_traits, btod_diag<8, 8> >;
...
template class btod_diag<7, 2>;
template class btod_diag<7, 3>;
template class btod_diag<7, 4>;
template class btod_diag<7, 5>;
template class btod_diag<7, 6>;
template class btod_diag<7, 7>;
template class btod_diag<8, 2>;
template class btod_diag<8, 3>;
template class btod_diag<8, 4>;
template class btod_diag<8, 5>;
template class btod_diag<8, 6>;
template class btod_diag<8, 7>;
template class btod_diag<8, 8>;
