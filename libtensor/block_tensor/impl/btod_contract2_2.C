...
template class btod_contract2<0, 2, 5>;
template class btod_contract2<0, 2, 6>;
...
template class btod_contract2<1, 1, 6>;
template class btod_contract2<1, 1, 7>;
...
template class btod_contract2<2, 0, 5>;
template class btod_contract2<2, 0, 6>;
