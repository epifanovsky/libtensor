#ifndef LIBTENSOR_BTO_CONTRACT2_CLST_OPTIMIZE_IMPL_H
#define LIBTENSOR_BTO_CONTRACT2_CLST_OPTIMIZE_IMPL_H

#include <libtensor/core/scalar_transf_double.h>
#include "../bto_contract2_clst_optimize.h"

namespace libtensor {


template<size_t N, size_t M, size_t K, typename T>
void bto_contract2_clst_optimize<N, M, K, T>::perform(contr_list &clst) {
    ...
    while(j1 != clst.end()) {
        ...
        while(j2 != clst.end()) {
            ...
            T d1 = j1->get_transf_a().get_scalar_tr().get_coeff() *
                    j1->get_transf_b().get_scalar_tr().get_coeff();
            T d2 = j2->get_transf_a().get_scalar_tr().get_coeff() *
...
template<size_t N, size_t M, size_t K, typename T>
inline bool bto_contract2_clst_optimize<N, M, K, T>::check_same_blocks(
...
template<size_t N, size_t M, size_t K, typename T>
bool bto_contract2_clst_optimize<N, M, K, T>::check_same_contr(
...
#endif // LIBTENSOR_BTO_CONTRACT2_CLST_OPTIMIZE_IMPL_H
