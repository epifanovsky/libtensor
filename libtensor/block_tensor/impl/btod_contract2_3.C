...
template class btod_contract2<1, 2, 5>;
template class btod_contract2<1, 2, 6>;
...
template class btod_contract2<2, 1, 5>;
template class btod_contract2<2, 1, 6>;
template class btod_contract2<3, 0, 1>;
template class btod_contract2<3, 0, 2>;
template class btod_contract2<3, 0, 3>;
template class btod_contract2<3, 0, 4>;
template class btod_contract2<3, 0, 5>;
