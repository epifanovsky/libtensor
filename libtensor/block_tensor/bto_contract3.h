#ifndef LIBTENSOR_BTO_CONTRACT3_H
#define LIBTENSOR_BTO_CONTRACT3_H
...
class bto_contract3 :
    public additive_gen_bto<N1 + N2 + N3, typename bto_traits<T>::bti_traits>,
    public noncopyable {
...
private:
    gen_bto_contract3<N1, N2, N3, K1, K2, bto_traits<T>,
        bto_contract3<N1, N2, N3, K1, K2, T> > m_gbto;
...
public:
     ...
     **/
    virtual const symmetry<N1 + N2 + N3, T> &get_symmetry() const {
     ...
     **/
    virtual const assignment_schedule<N1 + N2 + N3, T> &get_schedule()
            const {
    ...
    virtual void compute_block(
        ...
        compute_block(true, id, tensor_transf<N1 + N2 + N3, T>(), blkd);
    }
     ...
     **/
    void perform(block_tensor_i<N1 + N2 + N3, T> &btd, T k);

};

template<size_t N1, size_t N2, size_t N3, size_t K1, size_t K2>
using btod_contract3 = bto_contract3<N1, N2, N3, K1, K2, double>;

} // namespace libtensor

#endif // LIBTENSOR_BTO_CONTRACT3_H
