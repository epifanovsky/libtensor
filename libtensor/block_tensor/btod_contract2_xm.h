#ifndef LIBTENSOR_BTOD_CONTRACT2_XM_H
#define LIBTENSOR_BTOD_CONTRACT2_XM_H
...
struct btod_contract2_xm_clazz {
...
public:
    ...
    typedef typename btod_traits::bti_traits::element_type element_type;
...
private:
    ...
    gen_bto_contract2_sym<N, M, K, btod_traits>
            m_symc; //!< Symmetry of the result
    gen_bto_contract2< N, M, K, btod_traits, btod_contract2_xm<N, M, K> >
            m_gbto;
...
#endif // LIBTENSOR_BTOD_CONTRACT2_XM_H
