#ifndef LIBTENSOR_BTO_COPY_XM_H
#define LIBTENSOR_BTO_COPY_XM_H
...
private:
    gen_bto_copy< N, bto_traits<T>, bto_copy_xm<N, T> > m_gbto;
...
public:
     ...
     **/
    bto_copy_xm(block_tensor_rd_i<N, T> &bta, T c = 1.0) :
