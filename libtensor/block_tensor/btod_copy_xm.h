#ifndef LIBTENSOR_BTOD_COPY_XM_H
#define LIBTENSOR_BTOD_COPY_XM_H
...
private:
    gen_bto_copy< N, btod_traits, btod_copy_xm<N> > m_gbto;
...
public:
     ...
     **/
    btod_copy_xm(block_tensor_rd_i<N, double> &bta, double c = 1.0) :
...
#endif // LIBTENSOR_BTOD_COPY_XM_H
