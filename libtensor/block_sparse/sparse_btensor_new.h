...
public:
    ...
    //Copy constructor
    sparse_btensor_new(const sparse_btensor_new<N>& rhs) : m_bispace(rhs.m_bispace) { m_data_ptr = new T[m_bispace.get_nnz()]; memcpy(m_data_ptr,rhs.m_data_ptr,m_bispace.get_nnz()*sizeof(T)); }
