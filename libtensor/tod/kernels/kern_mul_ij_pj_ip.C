...
const char *kern_mul_ij_pj_ip::k_clazz = "kern_mul_ij_pj_ip";


void kern_mul_ij_pj_ip::run(const loop_registers<2, 1> &r) {
...
kernel_base<2, 1> *kern_mul_ij_pj_ip::match(const kern_mul_i_pi_p &z,
    ...
    return new kern_mul_ij_pj_ip(zz);
}
