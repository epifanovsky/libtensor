...
const char *kern_add_i_x_i_x::k_clazz = "kern_add_i_x_i_x";


void kern_add_i_x_i_x::run(const loop_registers<2, 1> &r) {

	linalg::add_i_i_x_x(m_ni, r.m_ptra[1], m_sib, r.m_ptra[0][0],
		r.m_ptrb[0], m_sic, m_d);
}


kernel_base<2, 1> *kern_add_i_x_i_x::match(const kern_add_generic &z,
	...
	return new kern_add_i_x_i_x(zz);
}
