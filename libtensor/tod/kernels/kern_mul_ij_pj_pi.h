#ifndef LIBTENSOR_KERN_MUL_IJ_PJ_PI_H
#define LIBTENSOR_KERN_MUL_IJ_PJ_PI_H
 ...
 **/
class kern_mul_ij_pj_pi : public kernel_base<2, 1> {
...
#endif // LIBTENSOR_KERN_MUL_IJ_PJ_PI_H
