...
const char *kern_mul_ijk_pqji_qpk::k_clazz = "kern_mul_ijk_pqji_qpk";


void kern_mul_ijk_pqji_qpk::run(const loop_registers<2, 1> &r) {
...
kernel_base<2, 1> *kern_mul_ijk_pqji_qpk::match(const kern_mul_ijk_pji_pk &z,
    ...
    //  nk  0    1     1
    //  nj  sja  0     sjc
    //  nq  sqa  sqb   0    -->  c_i#j#k = a_p#q#j#i b_q#p#k
    //  ------------------       [ijk_pqji_qpk]
    //
    ...
    return new kern_mul_ijk_pqji_qpk(zz);
}
