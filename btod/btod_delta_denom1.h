#ifndef LIBTENSOR_BTOD_DELTA_DENOM1_H
#define LIBTENSOR_BTOD_DELTA_DENOM1_H
...
public:
	 ...
	 **/
	btod_delta_denom1(block_tensor_i<2, double> &dov,
		double thresh = 0.0);

	/**	\brief Performs the operation
	 **/
	void perform(block_tensor_i<2, double> &t) throw(exception);

};

} // namespace libtensor

#endif // LIBTENSOR_BTOD_DELTA_DENOM1_H
