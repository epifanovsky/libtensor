#ifndef LIBTENSOR_TOD_DOTPROD_PERFORMANCE_H
#define LIBTENSOR_TOD_DOTPROD_PERFORMANCE_H
...
class tod_dotprod_p1 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
**/
template<size_t Repeats, size_t N, typename X>
class tod_dotprod_p2 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
**/
template<size_t Repeats, size_t N, typename X>
class tod_dotprod_p3 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
#endif // LIBTENSOR_TOD_DOTPROD_PERFORMANCE_H
