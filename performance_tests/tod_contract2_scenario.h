#ifndef LIBTENSOR_TOD_CONTRACT_SCENARIO_H
#define LIBTENSOR_TOD_CONTRACT_SCENARIO_H
...
class tod_contract2_scenario : public performance_test_scenario_i {
...
#endif // LIBTENSOR_TOD_CONTRACT2_SCENARIO_H
