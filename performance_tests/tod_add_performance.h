#ifndef LIBTENSOR_TOD_ADD_PERFORMANCE_H
#define LIBTENSOR_TOD_ADD_PERFORMANCE_H
...
class tod_add_p1 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
**/
template<size_t Repeats, size_t N, typename DimData>
class tod_add_p2 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
**/
template<size_t Repeats, size_t N, typename DimData>
class tod_add_p3 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
