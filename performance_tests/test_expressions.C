...
const char* test_expression_simple_add::k_clazz =
        "test_expression_simple_add";


const char* test_expression_permute_add::k_clazz =
        "test_expression_permute_add";


const char* test_expression_simple_copy::k_clazz =
        "test_expression_simple_copy";


const char* test_expression_permute_copy::k_clazz =
        "test_expression_permute_copy";


const char* test_expression_adc::k_clazz =
        "test_expression_adc";
