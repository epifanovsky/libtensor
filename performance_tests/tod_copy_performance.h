#ifndef LIBTENSOR_TOD_COPY_PERFORMANCE_H
#define LIBTENSOR_TOD_COPY_PERFORMANCE_H
...
class tod_copy_p1 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
**/
template<size_t Repeats, size_t N, typename X>
class tod_copy_p2 : public performance_test<Repeats> {
protected:
    virtual void do_calculate();
};
...
#endif // LIBTENSOR_TOD_COPY_PERFORMANCE_H
